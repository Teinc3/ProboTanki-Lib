package §-!!§
{
   ...
   public class §%"C§ implements §6!<§
   {
      private var container:Object3DContainer;
      
      public function §%"C§(param1:Object3DContainer = null)
      {
         this.objects = new Dictionary();
         this.container = new Object3DContainer();
         super();
         this.§class const continue§(param1);
      }
      ...
      public function § "A§(param1:Vector.<Object3D>) : void
      {
      ...
      public function §class const continue§(param1:Object3DContainer) : void
      {
         var _loc2_:Vector.<Object3D> = this.§@a§();
         this.container = param1 || new Object3DContainer();
         this.§ "A§(_loc2_);
      }
      
      private function §@a§() : Vector.<Object3D>
      {
