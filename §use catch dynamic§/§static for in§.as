package §use catch dynamic§
{
   ...
   public class §static for in§ extends AbstractPacket
   {
      ...
      public function §static for in§(param1:String = "", param2:String = "", param3:§class for case§ = null)
      {
         super();
         this.userId = param1;
         this.message = param2;
