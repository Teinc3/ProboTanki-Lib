package §7"j§
{
   ...
   public class §12§ extends Mesh
   {
      ...
      public function §12§(param1:Number, param2:Number, param3:Number, param4:Number)
      {
         super();
         this.originX = param3;
         this.originY = param4;
      ...
      public function §7"Z§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : void
      {
         this.a.u = param1;
         this.a.v = param2;
         this.b.u = param3;
