package com.hurlant.crypto.symmetric
{
   ...
   public class DESKey implements ISymmetricKey
   {
      ...
      protected function generateWorkingKey(param1:Boolean, param2:ByteArray, param3:uint) : Array
      {
         ...
         while(_loc9_ < 16)
         {
            ...
            while(_loc8_ < 24)
            {
               ...
               {
                  _loc4_[_loc10_] |= bigbyte[_loc8_];
               }
               if(_loc6_[pc2[_loc8_ + 24]])
               {
                  _loc4_[_loc11_] |= bigbyte[_loc8_];
               }
               _loc8_++;
            }
            _loc9_++;
      ...
      protected function desFunc(param1:Array, param2:ByteArray, param3:uint, param4:ByteArray, param5:uint) : void
      {
         ...
         _loc8_ = uint((_loc8_ = uint((_loc8_ = uint(_loc8_ | (param2[param3 + 1] & 0xFF) << 16)) | (param2[param3 + 2] & 0xFF) << 8)) | param2[param3 + 3] & 0xFF);
         _loc7_ = uint((param2[param3 + 4] & 0xFF) << 24);
         _loc7_ = uint((_loc7_ = uint((_loc7_ = uint(_loc7_ | (param2[param3 + 5] & 0xFF) << 16)) | (param2[param3 + 6] & 0xFF) << 8)) | param2[param3 + 7] & 0xFF);
         _loc6_ = uint((_loc8_ >>> 4 ^ _loc7_) & 0x0F0F0F0F);
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 4;
         _loc6_ = uint((_loc8_ ^= _loc6_ << 4 >>> 16 ^ _loc7_) & 0xFFFF);
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 16;
         _loc6_ = uint((_loc7_ >>> 2 ^ _loc8_) & 0x33333333);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 2;
         _loc6_ = uint((_loc7_ ^= _loc6_ << 2 >>> 8 ^ _loc8_) & 0xFF00FF);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 8;
         _loc7_ = uint((_loc7_ ^= _loc6_ << 8 << 1 | _loc7_ >>> 31 & 1) & 4294967295);
         _loc6_ = uint((_loc8_ ^ _loc7_) & 2863311530);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_;
         _loc8_ = uint((_loc8_ << 1 | _loc8_ >>> 31 & 1) & 4294967295);
         var _loc9_:uint = 0;
         while(_loc9_ < 8)
         {
            _loc6_ = uint(_loc7_ << 28 | _loc7_ >>> 4);
            _loc6_ = uint(_loc6_ ^ param1[_loc9_ * 4 + 0]);
            _loc10_ = uint(SP7[_loc6_ & 0x3F]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint(_loc10_ | SP5[_loc6_ >>> 8 & 0x3F])) | SP3[_loc6_ >>> 16 & 0x3F])) | SP1[_loc6_ >>> 24 & 0x3F]);
            _loc6_ = uint(_loc7_ ^ param1[_loc9_ * 4 + 1]);
            _loc10_ |= SP8[_loc6_ & 0x3F];
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint(_loc10_ |= SP8[_loc6_ & 0x3F] | SP6[_loc6_ >>> 8 & 0x3F])) | SP4[_loc6_ >>> 16 & 0x3F])) | SP2[_loc6_ >>> 24 & 0x3F]);
            _loc8_ ^= _loc10_;
            _loc6_ = uint((_loc6_ = uint(_loc8_ ^= _loc10_ << 28 | _loc8_ >>> 4)) ^ param1[_loc9_ * 4 + 2]);
            _loc10_ = uint(SP7[_loc6_ & 0x3F]);
            _loc10_ = uint((_loc10_ = uint((_loc10_ = uint(_loc10_ | SP5[_loc6_ >>> 8 & 0x3F])) | SP3[_loc6_ >>> 16 & 0x3F])) | SP1[_loc6_ >>> 24 & 0x3F]);
         ...
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 8;
         _loc6_ = uint((_loc8_ ^= _loc6_ << 8 >>> 2 ^ _loc7_) & 0x33333333);
         _loc7_ ^= _loc6_;
         _loc8_ ^= _loc6_ << 2;
         _loc6_ = uint((_loc7_ >>> 16 ^ _loc8_) & 0xFFFF);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 16;
         _loc6_ = uint((_loc7_ ^= _loc6_ << 16 >>> 4 ^ _loc8_) & 0x0F0F0F0F);
         _loc8_ ^= _loc6_;
         _loc7_ ^= _loc6_ << 4;
