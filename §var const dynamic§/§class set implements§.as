package §var const dynamic§
{
   ...
   public class §class set implements§ extends AbstractPacket
   {
      ...
      public function §class set implements§(param1:String = "", param2:§#">§ = null, param3:Vector.<§super set var§> = null)
      {
         super();
         this.shooter = param1;
      ...
      {
         return new §class set implements§();
      }
