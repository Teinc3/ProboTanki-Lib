package §3"q§
{
   ...
   public class §^!`§ extends §throw set super§
   {
      private var §extends with§:Number;
      ...
      override public function init() : void
      {
         ...
         {
            this.§extends with§ += get2UVRatio(_loc1_);
         }
         this.§extends with§ /= faces.length;
      ...
      override public function rotate(param1:Number) : void
      {
         ...
         super.rotate(param1);
         var _loc4_:Number = rotation * this.radius * this.§extends with§ % this.§6J§;
         var _loc5_:int = 0;
         while(_loc5_ < vertices.length)
         {
            _loc2_ = vertices[_loc5_];
            _loc3_ = §class package native§[_loc5_];
