package projects.tanks.clients.fp10.libraries.tanksservices.model.listener
{
   ...
   public class §false set finally§ implements UserNotifier
   {
      private var object:IGameObject;
      
      private var impl:UserNotifier;
      
      public function §false set finally§(param1:IGameObject, param2:UserNotifier)
      {
         super();
         this.object = param1;
         this.impl = param2;
      ...
      public function hasDataConsumer(param1:String) : Boolean
      {
         ...
         {
            Model.object = this.object;
            result = this.impl.hasDataConsumer(userId);
         }
         finally
         {
            Model.popObject();
