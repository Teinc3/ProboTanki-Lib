package alternativa.tanks.gui.buttons
{
   ...
   public class Renamed1708 extends GreyBigButton implements CountDownTimerOnCompleteAfter
   {
      private var timerLabel:CountDownTimerLabel;
      
      private var timer:CountDownTimer;
      
      public function Renamed1708()
      {
         super();
         this.init();
      }
      ...
      {
         this.hideTime();
         dispatchEvent(new Renamed1709(Renamed1709.Renamed1758));
      }
   }
}
