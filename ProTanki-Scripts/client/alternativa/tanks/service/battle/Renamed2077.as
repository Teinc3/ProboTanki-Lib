package alternativa.tanks.service.battle
{
   ...
   public class Renamed2077
   {
      ...
      private function onChangeFriendState(param1:FriendStateChangeEvent) : void
      {
         ...
         if(battleUserInfoService.Renamed3624(_loc3_))
         {
            _loc2_ = BattleItem(battleUserInfoService.Renamed3625(_loc3_).adapt(BattleItem));
