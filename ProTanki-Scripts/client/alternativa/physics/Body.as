package alternativa.physics
{
   ...
   public class Body
   {
      ...
      public var previousVelocity:Vector3;
      
      public var state:BodyState;
      
      private var maxSpeedXY:EncryptedNumber;
      ...
      public var pseudoVelocity:Vector3;
      
      public var pseudoAngularVelocity:Vector3;
      ...
      public function Body(param1:Number, param2:Matrix3, param3:Number)
      {
         ...
         this.maxSpeedXY = new EncryptedNumberImpl(0);
         this.forceAccum = new Vector3();
         this.torqueAccum = new Vector3();
         this.pseudoVelocity = new Vector3();
         this.pseudoAngularVelocity = new Vector3();
         super();
         this.mass = param1;
