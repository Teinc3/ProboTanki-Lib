package Renamed1181
{
   ...
   public class Renamed1184 extends Renamed6613
   {
      private var Renamed6618:Number;
      
      private var radius:Number;
      
      private var Renamed6619:Number;
      
      public function Renamed1184(param1:Number)
      {
         super();
         this.Renamed6619 = param1;
      }
      ...
      override public function init() : void
      {
         ...
         {
            this.Renamed6618 += get2UVRatio(_loc1_);
         }
         this.Renamed6618 /= faces.length;
      ...
      override public function rotate(param1:Number) : void
      {
         ...
         super.rotate(param1);
         var _loc4_:Number = rotation * this.radius * this.Renamed6618 % this.Renamed6619;
         var _loc5_:int = 0;
         while(_loc5_ < vertices.length)
         {
            _loc2_ = vertices[_loc5_];
            _loc3_ = Renamed6616[_loc5_];
