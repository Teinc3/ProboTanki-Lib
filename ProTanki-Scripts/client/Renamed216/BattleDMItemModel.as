package Renamed216
{
   ...
   import Renamed424.Renamed6250;
   
   public class BattleDMItemModel extends Renamed6250 implements Renamed4747, Renamed3639, BattleItem, ObjectLoadListener
   {
      [Inject]
      ...
      public function Renamed4965(param1:String) : void
      {
      ...
      private function Renamed6251() : void
      {
...
class BattleDMData
{
   public var users:Vector.<String>;
