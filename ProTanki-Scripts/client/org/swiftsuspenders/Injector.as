package org.swiftsuspenders
{
   ...
   public class Injector
   {
      ...
      {
         var _loc4_:InjectionConfig = this.getMapping(param1,param3);
         _loc4_.setResult(new InjectValueResult(param2));
         return _loc4_;
      }
      ...
      {
         var _loc4_:InjectionConfig = this.getMapping(param1,param3);
         _loc4_.setResult(new InjectClassResult(param2));
         return _loc4_;
      }
      ...
      {
         var _loc4_:InjectionConfig = this.getMapping(param1,param3);
         _loc4_.setResult(new InjectSingletonResult(param2));
         return _loc4_;
      }
      ...
      {
         var _loc4_:InjectionConfig = this.getMapping(param1,param3);
         _loc4_.setResult(new InjectOtherRuleResult(param2));
         return param2;
      }
      ...
      public function getMapping(param1:Class, param2:String = "") : InjectionConfig
      {
         ...
         var _loc4_:InjectionConfig = this.m_mappings[_loc3_ + "#" + param2];
         if(!_loc4_)
         {
      ...
      {
         var _loc2_:InjectionPoint = null;
         ...
         var _loc4_:InjecteeDescription = this.m_injecteeDescriptions[_loc3_] || this.getInjectionPoints(_loc3_);
         var _loc5_:Array;
         var _loc6_:int = int((_loc5_ = _loc4_.injectionPoints).length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            _loc2_ = _loc5_[_loc7_];
            _loc2_.applyInjection(param1,this);
            _loc7_++;
         }
      }
      ...
      {
         if(Boolean(this.m_parentInjector) && !param1)
         {
            this.m_attendedToInjectees = new Dictionary(true);
         }
      ...
      internal function getAncestorMapping(param1:Class, param2:String = null) : InjectionConfig
      {
         var _loc3_:InjectionConfig = null;
         var _loc4_:Injector = this.m_parentInjector;
         while(_loc4_)
         {
            _loc3_ = _loc4_.getConfigurationForRequest(param1,param2,false);
            if(Boolean(_loc3_) && _loc3_.hasOwnResponse())
            {
               return _loc3_;
            }
            _loc4_ = _loc4_.getParentInjector();
         }
         return null;
      }
      ...
      private function getConfigurationForRequest(param1:Class, param2:String, param3:Boolean = true) : InjectionConfig
      {
         ...
         var _loc5_:InjectionConfig = this.m_mappings[_loc4_ + "#" + param2];
         if(!_loc5_ && param3 && this.m_parentInjector && this.m_parentInjector.hasMapping(param1,param2))
         {
      ...
      private function addParentInjectionPoints(param1:XML, param2:Array) : void
      {
         ...
         var _loc5_:InjecteeDescription = this.m_injecteeDescriptions[_loc4_] || this.getInjectionPoints(_loc4_);
...
final class InjecteeDescription
{
   ...
   public function InjecteeDescription(param1:InjectionPoint, param2:Array)
   {
      super();
      this.ctor = param1;
