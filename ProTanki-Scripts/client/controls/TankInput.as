package controls
{
   ...
   public class TankInput extends Sprite
   {
      ...
      public function TankInput()
      {
         ...
         this.c = new Shape();
         this.r = new Shape();
         this.bmpLeft = new InputLeft(0,0);
         this.bmpCenter = new InputCenter(0,0);
         this.bmpRight = new InputRight(0,0);
         this.bmpLeftWrong = new InputLeftWrong(0,0);
         this.bmpCenterWrong = new InputCenterWrong(0,0);
         this.bmpRightWrong = new InputRightWrong(0,0);
         super();
         removeChildAt(0);
         addChild(this.bg);
