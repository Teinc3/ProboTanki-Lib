package §finally package else§
{
   public class §;!q§
   {
      ...
      public function §;!q§(param1:Number, param2:Number, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number)
      {
         super();
         this.t = param9;
