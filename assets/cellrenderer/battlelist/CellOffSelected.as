package assets.cellrenderer.battlelist
{
   ...
   public class CellOffSelected extends ButtonState
   {
      public function CellOffSelected()
      {
         super();
         bmpLeft = new cell_off_SELECTED_LEFT(1,1);
         bmpCenter = new cell_off_SELECTED_CENTER(1,1);
         bmpRight = new cell_off_SELECTED_RIGHT(1,1);
      }
