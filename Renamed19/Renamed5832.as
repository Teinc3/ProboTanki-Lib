package Renamed19
{
   internal class Renamed5832 extends Mesh
   {
      public function Renamed5832(param1:Number, param2:Material)
      {
         super();
         var _loc3_:Number = 4;
      ...
      {
         var _loc6_:Vertex;
         (_loc6_ = new Vertex()).alternativa3d::next = alternativa3d::vertexList;
      ...
      {
         var _loc4_:Face;
         (_loc4_ = new Face()).alternativa3d::next = alternativa3d::faceList;
