package §for set super§
{
   ...
   public class §!"N§ implements CollisionDetector
   {
      private static const §&#q§:Number = 0.01;
      
      private var §each package extends§:CollisionKdTree;
      
      private var threshold:Number = 0.0001;
      
      private var §;!z§:Vector.<§=-§>;
      
      private var §5!8§:Body;
      
      public function §!"N§()
      {
         this.colliders = {};
         this.§'!G§ = new RayHit();
         this.§ !=§ = new §set catch with§();
         this.§="=§ = new Vector3();
         this.§>M§ = new Vector3();
         this.§package var catch§ = new RayHit();
         this.§ !p§ = new AABB();
         this.shapeContacts = new Vector.<ShapeContact>();
         this.§each package extends§ = new CollisionKdTree();
         this.§;!z§ = new Vector.<§=-§>();
         super();
         var _loc1_:Number = 0.000001;
         this.§@"k§(CollisionShape.BOX,CollisionShape.BOX,new BoxBoxCollider(_loc1_));
         this.§@"k§(CollisionShape.BOX,CollisionShape.RECT,new BoxRectCollider(_loc1_));
         this.§@"k§(CollisionShape.BOX,CollisionShape.TRIANGLE,new BoxTriangleCollider(_loc1_));
         this.§import catch break§();
      }
      
      private function §@"k§(param1:int, param2:int, param3:Collider) : void
      {
         this.colliders[param1 | param2] = param3;
      }
      
      private function §import catch break§() : void
      {
         this.§5!8§ = new Body(1,new Matrix3(),10000000000);
         this.§5!8§.movable = false;
      }
      
      public function §9;§(param1:Vector.<CollisionShape>, param2:AABB = null) : void
      {
         var _loc3_:CollisionShape = null;
         for each(_loc3_ in param1)
         {
            _loc3_.body = this.§5!8§;
         }
         this.§each package extends§.createTree(param1,param2);
      }
      
      public function §in const super§(param1:§=-§) : void
      {
         param1.§set extends§ = false;
         this.§;!z§.push(param1);
      }
      
      public function §continue set class§(param1:§=-§) : void
      {
         var _loc2_:int = 0;
         var _loc3_:int = int(this.§;!z§.indexOf(param1));
         if(_loc3_ > -1)
         {
            _loc2_ = int(this.§;!z§.length - 1);
            this.§;!z§[_loc3_] = this.§;!z§[_loc2_];
            this.§;!z§.length = _loc2_;
         }
      }
      
      public function getTankBodies() : Vector.<§=-§>
      {
         return this.§;!z§;
      }
      ...
      public function getBodyContacts(param1:Vector.<BodyContact>) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = int(this.§;!z§.length);
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_)
         {
            _loc2_ = this.§;!z§[_loc6_];
            _loc2_.§[%§ = _loc2_.§set extends§;
            _loc3_ = _loc2_.body.tank;
            _loc2_.§set extends§ = _loc3_.§null set try§();
            _loc2_.§5#O§.length = 0;
            _loc6_++;
         }
         _loc6_ = 0;
         while(_loc6_ < _loc5_)
         {
            ...
            {
               _loc2_.§set extends§ = true;
            }
            _loc4_ = int(param1.length);
            this.§"J§(_loc2_,_loc6_ + 1,param1);
            _loc6_++;
         }
      }
      
      public function §""[§(param1:CollisionShape, param2:Vector.<ShapeContact>) : void
      {
         return this.§set for switch§(this.§each package extends§.rootNode,param1,param2);
      }
      
      private function §8]§(param1:§=-§, param2:Vector.<BodyContact>) : void
      {
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         ...
         {
            _loc3_ = int(param1.§=#x§.length);
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               this.§set for switch§(this.§each package extends§.rootNode,param1.§=#x§[_loc4_],this.shapeContacts);
               _loc4_++;
            }
            if(this.shapeContacts.length > 0)
            {
               (_loc5_ = BodyContact.create()).body1 = param1.body;
               _loc5_.body2 = this.§5!8§;
      ...
      private function §"J§(param1:§=-§, param2:int, param3:Vector.<BodyContact>) : void
      {
         var _loc4_:§=-§ = null;
         ...
         var _loc13_:int = int(this.§;!z§.length);
         var _loc14_:int = param2;
         while(_loc14_ < _loc13_)
         {
            _loc4_ = this.§;!z§[_loc14_];
            _loc5_ = param1.body;
            _loc6_ = _loc4_.body;
            if(!(_loc5_.frozen && _loc6_.frozen) && _loc5_.aabb.intersects(_loc6_.aabb,§&#q§))
            {
               this.getContacts(param1.§4#j§,_loc4_.§4#j§,this.shapeContacts);
               ...
               if(_loc7_ > 0)
               {
                  ...
                  if(_loc8_ && _loc9_)
                  {
                     ...
                     param1.§5#O§.push(_loc6_);
                     _loc4_.§5#O§.push(_loc5_);
                  }
                  else
                  {
                     _loc11_ = 0;
      ...
      public function getContacts(param1:CollisionShape, param2:CollisionShape, param3:Vector.<ShapeContact>) : void
      {
         ...
         if(!param1.aabb.intersects(param2.aabb,§&#q§))
         {
            return;
         }
      ...
      public function raycast(param1:Vector3, param2:Vector3, param3:int, param4:Number, param5:IRayCollisionFilter, param6:RayHit) : Boolean
      {
         ...
         var _loc8_:Boolean = this.§9#t§(param1,param2,param3,param4,param5,this.§package var catch§);
         if(!((_loc8_) || _loc7_))
         {
            return false;
         }
         if(_loc8_ && _loc7_)
         {
            if(param6.t > this.§package var catch§.t)
            {
               param6.copy(this.§package var catch§);
            }
            this.§package var catch§.clear();
            return true;
         }
         if(_loc7_)
         {
      ...
      {
         if(!this.§;#K§(param1,param2,this.§each package extends§.rootNode.boundBox,this.§ !=§))
         {
            return false;
         }
         if(this.§ !=§.max < 0 || this.§ !=§.min > param4)
         {
            return false;
         }
         if(this.§ !=§.min <= 0)
         ...
         {
            this.§>M§.x = param1.x + this.§ !=§.min * param2.x;
            this.§>M§.y = param1.y + this.§ !=§.min * param2.y;
            this.§>M§.z = param1.z + this.§ !=§.min * param2.z;
         }
         if(this.§ !=§.max > param4)
         {
            this.§ !=§.max = param4;
         }
         var _loc7_:Boolean = this.§>!M§(this.§each package extends§.rootNode,param1,this.§>M§,param2,param3,this.§ !=§.min,this.§ !=§.max,param5,param6);
      ...
      {
         var _loc6_:Boolean = this.raycastStatic(param1,param2,param3,param4,param5,this.§'!G§);
         this.§'!G§.clear();
         return _loc6_;
      }
      
      private function §set for switch§(param1:CollisionKdNode, param2:CollisionShape, param3:Vector.<ShapeContact>) : void
      {
         ...
         {
            _loc6_ = this.§each package extends§.staticChildren;
         ...
         {
            this.§set for switch§(param1.negativeNode,param2,param3);
         }
         if(_loc5_ > param1.coord)
         {
            this.§set for switch§(param1.positiveNode,param2,param3);
         }
         if(param1.splitTree != null && _loc4_ < param1.coord && _loc5_ > param1.coord)
         {
            this.§set for switch§(param1.splitTree.rootNode,param2,param3);
         }
      }
      
      private function §'!K§(param1:CollisionShape, param2:CollisionKdNode) : Boolean
      {
         ...
         {
            _loc5_ = this.§each package extends§.staticChildren;
         ...
         {
            if(this.§'!K§(param1,param2.splitTree.rootNode))
            {
               return true;
            }
         }
         ...
         {
            if(this.§'!K§(param1,param2.negativeNode))
            {
               return true;
            }
         }
         ...
         {
            if(this.§'!K§(param1,param2.positiveNode))
            {
               return true;
            }
         }
      ...
      private function §9#t§(param1:Vector3, param2:Vector3, param3:int, param4:Number, param5:IRayCollisionFilter, param6:RayHit) : Boolean
      {
         var _loc7_:§=-§ = null;
         ...
         {
            this.§ !p§.minX = _loc13_;
            this.§ !p§.maxX = param1.x;
         }
         else
         {
            this.§ !p§.minX = param1.x;
            this.§ !p§.maxX = _loc13_;
         }
         if(_loc14_ < param1.y)
         {
            this.§ !p§.minY = _loc14_;
            this.§ !p§.maxY = param1.y;
         }
         else
         {
            this.§ !p§.minY = param1.y;
            this.§ !p§.maxY = _loc14_;
         }
         if(_loc15_ < param1.z)
         {
            this.§ !p§.minZ = _loc15_;
            this.§ !p§.maxZ = param1.z;
         }
         else
         {
            this.§ !p§.minZ = param1.z;
            this.§ !p§.maxZ = _loc15_;
         }
         var _loc16_:Number = param4 + 1;
         var _loc17_:int = int(this.§;!z§.length);
         var _loc18_:int = 0;
         while(_loc18_ < _loc17_)
         {
            _loc7_ = this.§;!z§[_loc18_];
            _loc9_ = (_loc8_ = _loc7_.body).aabb;
            if(!(this.§ !p§.maxX < _loc9_.minX || this.§ !p§.minX > _loc9_.maxX || this.§ !p§.maxY < _loc9_.minY || this.§ !p§.minY > _loc9_.maxY || this.§ !p§.maxZ < _loc9_.minZ || this.§ !p§.minZ > _loc9_.maxZ))
            {
               _loc10_ = 0;
      ...
      private function §;#K§(param1:Vector3, param2:Vector3, param3:AABB, param4:§set catch with§) : Boolean
      {
         var _loc5_:Number = NaN;
      ...
      private function §>!M§(param1:CollisionKdNode, param2:Vector3, param3:Vector3, param4:Vector3, param5:int, param6:Number, param7:Number, param8:IRayCollisionFilter, param9:RayHit) : Boolean
      {
         ...
         if(param1.indices != null && this.§!!=§(param2,param4,param5,this.§each package extends§.staticChildren,param1.indices,param8,param9))
         {
            return true;
         }
         if(param1.axis == -1)
         ...
         {
            return this.§>!M§(_loc11_,param2,param3,param4,param5,param6,param7,param8,param9);
         }
         _loc12_ = this.§>!M§(_loc11_,param2,param3,param4,param5,param6,_loc10_,param8,param9);
         if(_loc12_)
         {
            return true;
         }
         this.§>M§.x = param2.x + _loc10_ * param4.x;
         this.§>M§.y = param2.y + _loc10_ * param4.y;
         this.§>M§.z = param2.z + _loc10_ * param4.z;
         if(param1.splitTree != null)
         {
            ...
            while(_loc13_ != null && _loc13_.axis != -1)
            {
               ...
               {
                  case 0:
                     _loc13_ = this.§>M§.x < _loc13_.coord ? _loc13_.negativeNode : _loc13_.positiveNode;
                     break;
                  case 1:
                     _loc13_ = this.§>M§.y < _loc13_.coord ? _loc13_.negativeNode : _loc13_.positiveNode;
                     break;
                  case 2:
                     _loc13_ = this.§>M§.z < _loc13_.coord ? _loc13_.negativeNode : _loc13_.positiveNode;
                     break;
               }
            }
            if(_loc13_ != null && _loc13_.indices != null)
            {
               ...
               {
                  _loc16_ = this.§each package extends§.staticChildren[_loc13_.indices[_loc15_]];
         ...
         return this.§>!M§(_loc11_ == param1.negativeNode ? param1.positiveNode : param1.negativeNode,param2,this.§>M§,param4,param5,_loc10_,param7,param8,param9);
      }
      
      private function §!!=§(param1:Vector3, param2:Vector3, param3:int, param4:Vector.<CollisionShape>, param5:Vector.<int>, param6:IRayCollisionFilter, param7:RayHit) : Boolean
      {
      ...
      public function §switch catch get§(param1:CollisionShape) : Boolean
      {
         return this.§'!K§(param1,this.§each package extends§.rootNode);
      }
      
      public function destroy() : void
      {
         var _loc1_:§=-§ = null;
         this.§each package extends§.destroyTree();
         this.§each package extends§ = null;
