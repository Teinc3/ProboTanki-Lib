package platform.client.fp10.core.service.serverlog.impl
{
   ...
   public class ServerLogPanel
   {
      ...
      private var entries:Vector.<LogEntry>;
      
      private var filteredEntries:Vector.<LogEntry>;
      
      private var logLevels:Array;
      
      private var textFields:Vector.<TextField>;
      
      private var filterButtons:Vector.<FilterButton>;
      ...
      {
         this.textFormat = new TextFormat("Courier",14);
         this.levelFilter = {};
         this.entries = new Vector.<LogEntry>();
         this.filteredEntries = new Vector.<LogEntry>();
         this.logLevels = [];
         this.textFields = new Vector.<TextField>();
         this.filterButtons = new Vector.<FilterButton>();
         super();
         this.stage = param1;
