package §^#l§
{
   ...
   import controls.statassets.§break try§;
   ...
   public class §import for const§ extends CellRenderer
   {
      protected var nicon:DisplayObject;
      
      private var sicon:DisplayObject;
      
      public function §import for const§()
      {
         super();
      }
      ...
      {
         _data = param1;
         var _loc2_:DisplayObject = new §break try§();
         var _loc3_:DisplayObject = new §-!@§();
      ...
      protected function myIcon(param1:Object) : Sprite
      {
         ...
         (_loc7_ = new LabelBase()).autoSize = TextFieldAutoSize.NONE;
