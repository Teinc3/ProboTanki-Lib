package §#"D§
{
   ...
   public class §var catch dynamic§ extends Mesh
   {
      private static const MAX_PROGRESS:Number = 100;
      
      private var progress:Number = 0;
      
      private var §8E§:Material;
      
      private var §static package for§:Material;
      
      private var §else package default§:Material;
      
      private var §<"5§:Material;
      
      private var §break const try§:Material;
      ...
      public function §var catch dynamic§(param1:Number, param2:Number, param3:Material, param4:Material, param5:Material, param6:Material, param7:Material)
      {
         this.uvs = new Vector.<Point>();
         this.§true var return§ = new Vector.<Vector3D>();
         super();
         this.§8E§ = param3;
         this.§static package for§ = param4;
         this.§else package default§ = param5;
         this.§<"5§ = param6;
         this.§break const try§ = param7;
         useShadowMap = false;
         useLight = false;
      ...
      private function createGeometry(param1:Number, param2:Number) : void
      {
         ...
         this.§true var return§[0] = new Vector3D(0,_loc7_,0);
         this.§true var return§[1] = new Vector3D(-_loc6_,0,0);
         this.§true var return§[2] = new Vector3D(0,-_loc7_,0);
         this.§true var return§[3] = new Vector3D(_loc6_,0,0);
      ...
      private function update() : void
      {
         ...
         var _loc17_:Material = _loc13_ < 0 ? this.§<"5§ : this.§static package for§;
         var _loc18_:Material = _loc13_ < 0 ? this.§break const try§ : this.§else package default§;
         var _loc19_:int = 0;
         while(_loc19_ < 4)
         {
            _loc1_ = this.§7!2§[_loc19_];
            if(_loc19_ < _loc15_)
            {
            ...
            {
               _loc1_.material = this.§8E§;
            }
            _loc2_ = _loc1_.alternativa3d::wrapper.alternativa3d::vertex;
            _loc9_ = (_loc19_ + 1) % 4;
            _loc5_ = this.§true var return§[_loc9_];
         ...
         {
            _loc1_ = this.§7!2§[_loc15_];
            _loc1_.material = _loc17_;
            _loc4_ = this.§true var return§[0];
            _loc6_ = this.uvs[0];
            _loc5_ = this.§true var return§[_loc16_];
