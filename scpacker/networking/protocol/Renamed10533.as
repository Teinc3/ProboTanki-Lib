package scpacker.networking.protocol
{
   ...
   import scpacker.networking.protocol.codec.custom.Renamed10526;
   import scpacker.networking.protocol.codec.custom.Renamed10527;
   ...
   import scpacker.networking.protocol.codec.custom.Renamed10528;
   import scpacker.networking.protocol.codec.custom.Renamed10529;
   ...
   public class Renamed536
   {
      ...
      public function init() : void
      {
         ...
         this.registerCodecForType(new Renamed10528(this));
         ...
         this.registerCodecForType(new Renamed10529(this));
         ...
         this.registerCodecForType(new Renamed10527(this));
         ...
         this.registerCodecForType(new Renamed10526(this));
