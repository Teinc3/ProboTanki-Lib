package scpacker.networking.protocol.codec.custom
{
   ...
   public class VectorCodecTargetHit implements ICodec
   {
      ...
      public function VectorCodecTargetHit(param1:§?"s§)
      {
         super();
      ...
      public function decode(param1:ByteArray) : Object
      {
         ...
         var _loc3_:Vector.<§super set var§> = new Vector.<§super set var§>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = §super set var§(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ByteArray, param2:Object) : int
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:Vector.<§super set var§> = Vector.<§super set var§>(param2);
