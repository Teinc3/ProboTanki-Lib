package scpacker.networking.protocol.codec.custom
{
   ...
   public class VectorCodecWeeklyQuestRewardItem implements ICodec
   {
      ...
      public function VectorCodecWeeklyQuestRewardItem(param1:§?"s§)
      {
         super();
      ...
      public function decode(param1:ByteArray) : Object
      {
         ...
         var _loc3_:Vector.<§6z§> = new Vector.<§6z§>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = §6z§(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ByteArray, param2:Object) : int
      {
         ...
         var _loc3_:Vector.<§6z§> = Vector.<§6z§>(param2);
