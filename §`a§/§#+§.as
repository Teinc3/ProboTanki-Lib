package §`a§
{
   ...
   public class §#+§ extends §["D§ implements §2#?§
   {
      private static const §"#V§:Number = 48;
      ...
      public function init(param1:Vector3, param2:Vector3, param3:Number, param4:Number, param5:Material, param6:int) : void
      {
         ...
         this.§2#H§ = 1 / param6;
         this.§-#E§.init(§"#V§,param3,param4,param5);
      }
