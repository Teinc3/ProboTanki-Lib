package Renamed4129
{
   ...
   public class Renamed4130 implements ICodec
   {
      private var elementCodec:ICodec;
      
      private var Renamed5009:Boolean;
      
      public function Renamed4130(param1:Boolean)
      {
         super();
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         var _loc3_:Vector.<ImageResource> = new Vector.<ImageResource>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = ImageResource(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc4_:Vector.<ImageResource> = Vector.<ImageResource>(param2);
