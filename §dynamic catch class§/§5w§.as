package §dynamic catch class§
{
   ...
   public class §5w§
   {
      ...
      public function §5w§()
      {
         ...
         {
            map = {};
            for each(_loc1_ in §break package super§)
            {
               map[_loc1_] = true;
            }
         }
      ...
      public function §8#!§(param1:Vector.<Object3D>) : void
      {
         this.§9B§(param1);
         Mesh.calculateVerticesNormalsBySmoothingGroupsForMeshList(param1,0.01);
      }
      
      private function §9B§(param1:Vector.<Object3D>) : void
      {
