package Renamed48
{
   ...
   import Renamed72.Renamed9495;
   import scpacker.tanks.WeaponsManager;
   import Renamed89.Renamed9496;
   import Renamed89.Renamed90;
   
   public class Renamed49 extends Renamed4863 implements Renamed14, Renamed43, Renamed4684, Renamed511
   {
      [Inject]
      ...
      {
         var _loc2_:Renamed13 = getInitParam();
         var _loc3_:Renamed3040 = new Renamed3040(_loc2_.damageAreaConeAngle,Renamed668.Renamed674(_loc2_.damageAreaRange));
      ...
      public function Renamed2891(param1:ClientObject) : Renamed990
      {
         ...
         var _loc3_:Renamed8354 = this.Renamed3159(param1);
         var _loc4_:Renamed665 = battleService.Renamed619().Renamed692();
         var _loc5_:Renamed3040 = Renamed3040(_loc2_.turret.getParams(Renamed3040));
         var _loc6_:Renamed3367 = new Renamed3367(_loc5_.Renamed3042(),_loc5_.Renamed3041(),Renamed9496.Renamed9498,Renamed9496.Renamed9499,_loc4_,battleService.Renamed626());
         var _loc7_:Renamed3150 = new Renamed3150();
         var _loc8_:Renamed90 = Renamed9497(_loc2_.turret);
         var _loc9_:Renamed990 = new Renamed8348(_loc8_.Renamed9500(),_loc8_.Renamed9501(),_loc8_.Renamed9502(),_loc8_.Renamed9503(),_loc6_,_loc7_,this,_loc3_);
      ...
      private function Renamed3159(param1:ClientObject) : Renamed8354
      {
         ...
         var _loc4_:Renamed9489 = WeaponsManager.getFrezeeSFXModel(param1);
         return _loc4_.Renamed9494(_loc3_.Renamed3042(),_loc3_.Renamed3041(),param1);
      }
