package Renamed342
{
   ...
   public class Renamed7963
   {
      ...
      public function Renamed7963()
      {
         ...
         {
            map = {};
            for each(_loc1_ in Renamed7964)
            {
               map[_loc1_] = true;
            }
         }
      ...
      public function Renamed7965(param1:Vector.<Object3D>) : void
      {
         this.Renamed7966(param1);
         Mesh.calculateVerticesNormalsBySmoothingGroupsForMeshList(param1,0.01);
      }
      
      private function Renamed7966(param1:Vector.<Object3D>) : void
      {
