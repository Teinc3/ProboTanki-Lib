package §switch var set§
{
   ...
   public class §return set set§ implements ICodec
   {
      private var elementCodec:ICodec;
      
      private var §?"_§:Boolean;
      
      public function §return set set§(param1:Boolean)
      {
         super();
         this.§?"_§ = param1;
      }
      ...
      {
         var _loc3_:ModelData = null;
         if(param2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _loc4_:Vector.<ModelData> = Vector.<ModelData>(param2);
