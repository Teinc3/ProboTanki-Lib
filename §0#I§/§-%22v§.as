package §0#I§
{
   ...
   public class §-"v§ implements §with super§, §`§, §else if§
   {
      [Inject]
      ...
      private static const §extends catch use§:int = 1000;
      ...
      public function §-"v§(param1:int, param2:§class for case§, param3:Vector3, param4:int, param5:int, param6:§throw const switch§, param7:CollisionDetector, param8:§break for catch§)
      {
         this._state = §=x§.AT_BASE;
         super();
         this._id = param1;
         this.teamType = param2;
         this.§package const use§ = param3.clone();
         this._state = §=x§.AT_BASE;
         ...
         this.startTime = §extends catch use§ * Math.random();
      }
      ...
      private function §4#I§(param1:§class for case§) : void
      {
         ...
         var _loc3_:§const const case§ = _loc2_.§ #i§(§class for case§.RED);
      ...
      public function checkTrigger(param1:Body) : void
      {
         ...
         contacts.length = 0;
         this.callback.§const set native§(this._id);
      }
      
      public function render(param1:int, param2:int) : void
      {
         this.skin.§true const switch§(int((param1 - this.startTime) / §extends catch use§));
         if(this.§!!I§ != null)
         {
