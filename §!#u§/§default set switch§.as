package §!#u§
{
   ...
   public class §default set switch§
   {
      ...
      private var §return const continue§:ICodec;
      ...
      public function §default set switch§(param1:IModel)
      {
         this.§use const while§ = Long.getLong(1744513692,181388452);
         this.§native set import§ = Long.getLong(430590662,-88054305);
         this.§^"k§ = Long.getLong(625603135,-1078364647);
         super();
         this.model = param1;
