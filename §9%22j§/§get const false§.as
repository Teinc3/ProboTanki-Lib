package §9"j§
{
   ...
   public class §get const false§ extends AbstractPacket
   {
      public var time:int;
      ...
      public function §get const false§(param1:int = 0, param2:§#">§ = null, param3:Vector.<String> = null, param4:Vector.<§#">§> = null, param5:Vector.<int> = null, param6:Vector.<§#">§> = null, param7:Vector.<§#">§> = null)
      {
         super();
         this.time = param1;
