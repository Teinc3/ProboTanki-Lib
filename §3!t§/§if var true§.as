package §3!t§
{
   ...
   public class §if var true§ implements ICodec
   {
      private var elementCodec:ICodec;
      
      private var §?"_§:Boolean;
      
      public function §if var true§(param1:Boolean)
      {
         super();
         this.§?"_§ = param1;
      }
      ...
      {
         var _loc3_:StringPair = null;
         if(param2 == null)
         {
            throw new Error("Object is null. Use @ProtocolOptional annotation.");
         }
         var _loc4_:Vector.<StringPair> = Vector.<StringPair>(param2);
