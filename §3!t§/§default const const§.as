package §3!t§
{
   ...
   public class §default const const§ implements ICodec
   {
      ...
      public function §default const const§()
      {
         super();
      }
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.§`"f§ = param1.getCodec(new TypeCodecInfo(int,false));
      }
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         _loc2_.value = this.§`"f§.decode(param1) as int;
         return _loc2_;
      }
