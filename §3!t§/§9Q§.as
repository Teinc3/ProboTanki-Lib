package §3!t§
{
   ...
   public class §9Q§ implements ICodec
   {
      private var elementCodec:ICodec;
      
      private var §?"_§:Boolean;
      
      public function §9Q§(param1:Boolean)
      {
         super();
         this.§?"_§ = param1;
      }
      ...
      {
         this.elementCodec = param1.getCodec(new TypeCodecInfo(§?[§,false));
         if(this.§?"_§)
         {
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Vector.<§?[§> = Vector.<§?[§>(param2);
