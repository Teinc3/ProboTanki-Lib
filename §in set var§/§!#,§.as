package §in set var§
{
   ...
   public class §!#,§ extends §]#A§ implements §null for break§, §catch catch false§, §static set case§, §throw package continue§
   {
      [Inject]
      ...
      {
         var _loc2_:§while set true§ = getInitParam();
         var _loc3_:§class set do§ = new §class set do§(_loc2_.coneAngle,§+$%§.§use final§(_loc2_.range));
      ...
      public function §return package set§(param1:ClientObject) : §4"3§
      {
         ...
         var _loc4_:§class set do§ = §class set do§(_loc2_.turret.getParams(§class set do§));
         var _loc5_:§ "4§ = new § "4§(_loc4_.§super for§(),_loc4_.§&!W§(),§extends catch null§.§import package each§,§extends catch null§.§`!i§,_loc3_,battleService.§?!r§());
         var _loc6_:§6#L§ = new §6#L§();
         var _loc7_:§var const with§ = §7#Z§(_loc2_.turret);
         var _loc8_:Number = _loc7_.§43§();
         var _loc9_:Number = _loc7_.§false set class§();
         var _loc10_:Number = _loc7_.§finally catch with§();
         var _loc11_:§4"3§ = new §"K§(_loc8_,_loc9_,_loc10_,_loc7_.§implements catch return§(),_loc5_,_loc6_,this,this.§continue for each§(param1));
      ...
      private function §continue for each§(param1:ClientObject) : §3"3§
      {
         ...
         var _loc4_:§"#@§ = WeaponsManager.getFlamethrowerSFX(param1);
         return _loc4_.§!"2§(_loc3_.§super for§(),_loc3_.§&!W§(),param1);
      }
