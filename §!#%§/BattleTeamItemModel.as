package §!#%§
{
   ...
   public class BattleTeamItemModel extends §case package static§ implements §if catch break§, §<"U§, BattleItem, ObjectLoadListener
   {
      [Inject]
      ...
      public function objectLoaded() : void
      {
         ...
         this.§try for break§(_loc2_,_loc1_.usersRed,_loc1_.friendsRed);
         var _loc3_:Vector.<String> = getInitParam().usersBlue;
         this.§try for break§(_loc3_,_loc1_.usersBlue,_loc1_.friendsBlue);
      }
      
      private function §try for break§(param1:Vector.<String>, param2:Vector.<String>, param3:Vector.<String>) : void
      {
      ...
      private function §5!A§(param1:String, param2:Vector.<String>, param3:Vector.<String>) : void
      {
      ...
      private function §'!7§(param1:String, param2:Vector.<String>, param3:Vector.<String>) : void
      {
         if(BattleSelectVectorUtil.containsElementInVector(param2,param1))
         {
            param3.push(param1);
      ...
      public function §const var set§(param1:String, param2:§class for case§) : void
      {
         switch(param2)
         {
            case §class for case§.RED:
               this.§["f§(param1,this.data().usersRed,this.data().friendsRed);
               break;
            case §class for case§.BLUE:
               this.§["f§(param1,this.data().usersBlue,this.data().friendsBlue);
         }
      ...
      private function §["f§(param1:String, param2:Vector.<String>, param3:Vector.<String>) : void
      {
         param2.push(param1);
      }
      ...
      {
         this.§'!7§(param1,this.data().usersRed,this.data().friendsRed);
         this.§'!7§(param1,this.data().usersBlue,this.data().friendsBlue);
         battleListFormService.updateUsersCountTeam(object.name,this.data().usersRed.length,this.data().usersBlue.length,this.data().friendsRed.length,this.data().friendsBlue.length);
      }
      
      public function onDeleteFriend(param1:String) : void
      {
         this.§5!A§(param1,this.data().usersRed,this.data().friendsRed);
         this.§5!A§(param1,this.data().usersBlue,this.data().friendsBlue);
         battleListFormService.updateUsersCountTeam(object.name,this.data().usersRed.length,this.data().usersBlue.length,this.data().friendsRed.length,this.data().friendsBlue.length);
      }
   }
}
