package alternativa.init
{
   ...
   import Renamed501.Renamed546;
   import Renamed501.Renamed547;
   import Renamed501.Renamed548;
   import alternativa.osgi.OSGi;
   import alternativa.osgi.service.launcherparams.ILauncherParams;
   import alternativa.osgi.service.locale.ILocaleService;
   import alternativa.tanks.controller.commands.Renamed549;
   import alternativa.tanks.controller.commands.Renamed550;
   ...
   import alternativa.tanks.controller.commands.captcha.Renamed551;
   ...
   import alternativa.tanks.controller.commands.goto.Renamed552;
   ...
   import alternativa.tanks.view.Renamed556;
   ...
   import alternativa.tanks.view.Renamed557;
   ...
   public class EntranceContext extends Context
   {
      ...
      override public function startup() : void
      {
         ...
         injector.mapSingletonOf(IEntranceServerFacade,Renamed545);
         injector.mapSingletonOf(IEntranceClientFacade,Renamed547);
         injector.mapSingletonOf(Renamed555,Renamed548);
         injector.mapSingletonOf(Renamed554,Renamed546);
         ...
         mediatorMap.mapView(Renamed559,Renamed556);
         mediatorMap.mapView(PasswordRestoreForm,PasswordRestoreFormMediator);
         mediatorMap.mapView(Renamed558,Renamed557);
         ...
         commandMap.mapEvent(Renamed553.INVITE_ENTERED,Renamed550,Renamed553);
         commandMap.mapEvent(SendNewPasswordAndEmailToChangeEvent.SEND,Renamed549,SendNewPasswordAndEmailToChangeEvent);
         ...
         commandMap.mapEvent(NavigationEvent.GO_TO_INVITE_FORM,Renamed552,NavigationEvent);
         commandMap.mapEvent(NavigationEvent.GO_TO_STAND_ALONE_CAPTCHA,GoToStandaloneCaptcha,NavigationEvent);
         commandMap.mapEvent(CheckCaptchaAnswerEvent.EVENT_TYPE,Renamed551,CheckCaptchaAnswerEvent);
