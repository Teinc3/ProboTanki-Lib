package alternativa.tanks.battle.objects.tank
{
   ...
   public class § "L§
   {
      private static const §8A§:PhysicsMaterial = new PhysicsMaterial(0,1);
      
      private static const §'g§:PhysicsMaterial = new PhysicsMaterial(0,0.2);
      ...
      public static function §[#`§(param1:Vector3, param2:Number, param3:§=-§) : void
      {
         ...
         var _loc19_:CollisionBox = new CollisionBox(new Vector3(param1.x,_loc17_,_loc18_),§super const continue§.§finally catch while§,§'g§);
         ...
         param3.§=#x§.push(_loc19_);
         _loc19_ = new CollisionBox(new Vector3(param1.x,_loc17_,_loc18_),§super const continue§.§finally catch while§,§'g§);
         _loc20_.setRotationMatrix(_loc21_,0,0);
         _loc20_.setPosition(new Vector3(0,-_loc22_,_loc23_));
         param3.body.addCollisionShape(_loc19_,_loc20_);
         param3.§=#x§.push(_loc19_);
         ...
         var _loc27_:CollisionBox = new CollisionBox(_loc25_,§super const continue§.§finally catch while§,§'g§);
         param3.body.addCollisionShape(_loc27_,_loc26_);
         param3.§=#x§.push(_loc27_);
         ...
         var _loc31_:CollisionBox = new CollisionBox(_loc29_,§super const continue§.§finally catch while§,§8A§);
         param3.body.addCollisionShape(_loc31_,_loc30_);
         param3.§=#x§.push(_loc31_);
      }
      
      public static function §try const false§(param1:Vector3, param2:Number, param3:§=-§) : void
      {
         var _loc4_:Vector3 = new Vector3(param1.x,param1.y,param2 / 2);
         var _loc5_:CollisionBox = new CollisionBox(_loc4_,0,§'g§);
         var _loc6_:Matrix4;
