package alternativa.tanks.battle.objects.tank.tankskin
{
   ...
   public class §"#3§
   {
      ...
      private static function §?@§(param1:Face) : Number
      {
         var _loc2_:Vector.<Vertex> = param1.vertices;
         return §default set function§(_loc2_[0],_loc2_[1]);
      }
      
      private static function §default set function§(param1:Vertex, param2:Vertex) : Number
      {
