package alternativa.tanks.model.info
{
   ...
   public class §var var break§
   {
      ...
      public function §var var break§()
      {
         super();
      }
      
      public static function §return set finally§() : String
      {
         return "";
      }
      
      public static function §dynamic package§(param1:Long) : String
      {
