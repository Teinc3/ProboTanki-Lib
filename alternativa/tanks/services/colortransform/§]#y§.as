package alternativa.tanks.services.colortransform
{
   ...
   public class §]#y§
   {
      ...
      public static function §for const try§(param1:BitmapData, param2:ColorTransform) : BitmapData
      {
      ...
      public static function §0"]§(param1:ColorTransform, param2:ColorTransform) : Boolean
      {
         if(param1 == param2)
         {
            return true;
      ...
      public static function §=!k§(param1:§static static§, param2:Number) : ColorTransform
      {
         var _loc3_:§break var override§ = null;
         var _loc4_:§break var override§ = null;
         ...
         {
            _loc3_ = new §break var override§(param1.lightColor);
            _loc4_ = new §break var override§(param1.shadowColor);
            ...
            _loc8_ = (_loc4_.§#!@§() >> 16 & 0xFF) / 255;
            _loc9_ = (_loc4_.§#!@§() >> 8 & 0xFF) / 255;
            _loc10_ = (_loc4_.§#!@§() & 0xFF) / 255;
            _loc11_ = (_loc3_.§#!@§() >> 16 & 0xFF) / 255;
            _loc12_ = (_loc3_.§#!@§() >> 8 & 0xFF) / 255;
            _loc13_ = (_loc3_.§#!@§() & 0xFF) / 255;
