package alternativa.tanks.models.battle.gui.gui.statistics.field.score.ctf
{
   ...
   public class §&!O§ extends Sprite implements §continue package var§
   {
      private static var §final package extends§:Class = §switch catch§;
      
      private static var §7"y§:Class = §in set continue§;
      
      private static var §case const while§:Class = §null const override§;
      
      private static var §^!U§:Class = §native const return§;
      
      private static var §continue var function§:Class = §9&§;
      ...
      private var §const var switch§:§1!"§;
      ...
      public function §&!O§()
      {
         this.§const var switch§ = new §1!"§(§=#b§,16777215);
         ...
         this.§var set true§ = new §#"5§(new §final package extends§(),new §case const while§(),new §continue var function§(),this.blinker);
         this.§var set true§.y = 5;
         addChild(this.§var set true§);
      ...
      public function §in var switch§(param1:int, param2:int) : void
      {
         ...
         this.§var set true§.setState(§#"5§.§const package while§);
         this.update();
      }
      ...
      public function set §override const const§(param1:int) : void
      {
         ...
         this.labelRed.text = param1.toString();
         this.§var set true§.setState(§#"5§.§^"N§);
         this.update();
      }
      ...
      public function set §break var for§(param1:int) : void
      {
         ...
         this.§throw package in§.setState(§#"5§.§^"N§);
         this.update();
      }
      
      public function showFlagAtBase(param1:§class for case§) : void
      {
         var _loc2_:§#"5§ = this.§ !'§(param1);
         _loc2_.setState(§#"5§.§const package while§);
      }
      
      public function showFlagCarried(param1:§class for case§) : void
      {
         var _loc2_:§#"5§ = this.§ !'§(param1);
         _loc2_.setState(§#"5§.§null package final§);
      }
      
      public function showFlagDropped(param1:§class for case§) : void
      {
         var _loc2_:§#"5§ = this.§ !'§(param1);
         _loc2_.setState(§#"5§.§!#f§);
      }
      ...
      private function update() : void
      {
         ...
         this.§var set true§.x = _loc3_;
         _loc3_ += §return catch package§ + _loc1_ + _loc1_;
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.§var set true§.update(_loc2_,_loc3_);
         §>!a§(this.labelRed,this.§const var switch§,this.§var set true§.§null catch extends§);
         §>!a§(this.§;!a§,this.§`!0§,this.§throw package in§.§null catch extends§);
      }
      
      private function § !'§(param1:§class for case§) : §#"5§
      {
         switch(param1)
         {
            case §class for case§.BLUE:
               return this.§var set true§;
            case §class for case§.RED:
               return this.§throw package in§;
            default:
