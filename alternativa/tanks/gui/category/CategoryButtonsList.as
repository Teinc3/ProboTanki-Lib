package alternativa.tanks.gui.category
{
   ...
   public class CategoryButtonsList extends DiscreteSprite
   {
      ...
      private var buttons:Vector.<ItemCategoryButton>;
      
      private var categoryToButton:Dictionary;
      ...
      {
         this.buttons = new Vector.<ItemCategoryButton>();
         this.categoryToButton = new Dictionary();
         super();
