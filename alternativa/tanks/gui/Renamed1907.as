package alternativa.tanks.gui
{
   ...
   public class Renamed1907 extends DialogWindow
   {
      [Inject]
      ...
      private static const Renamed1910:int = 90;
      
      private static const Renamed1911:int = 510;
      
      private static const Renamed1912:int = 3;
      ...
      private var reward:Vector.<Renamed1906>;
      
      public function Renamed1907(param1:Vector.<Renamed1906>)
      {
      ...
      private function Renamed1913() : void
      {
      ...
      private function Renamed1914() : void
      {
         var _loc1_:Bitmap = new Bitmap(Renamed1909);
         this.window.addChild(_loc1_);
      ...
      private function addMessage() : void
      {
         ...
         this.messageLabel.width = Renamed1911;
         this.messageLabel.x = (WINDOW_WIDTH - Renamed1911) / 2;
         this.messageLabel.y = Renamed1910 + MARGIN * 2 + SPACE;
      ...
      private function Renamed1916() : void
      {
         ...
         {
            _loc1_ = _loc6_ > 2 && this.reward.length < Renamed1912 * 2;
            _loc2_ = _loc1_ ? int((_loc5_.width + SPACE) / 2) : int(0);
            _loc3_ = _loc6_ % Renamed1912 * (_loc5_.width + SPACE) + _loc2_;
            _loc4_ = (_loc5_.height + SPACE) * int(_loc6_ / Renamed1912);
            this.Renamed1917(this.reward[_loc6_].Renamed1918,this.reward[_loc6_].count,_loc3_,_loc4_);
            _loc6_++;
         }
      ...
      private function Renamed1917(param1:ImageResource, param2:int, param3:int, param4:int) : void
      {
