package alternativa.engine3d.loaders
{
   ...
   public class Parser3DS
   {
      ...
      private function parseVertices(param1:ObjectData) : void
      {
         ...
         {
            var _loc5_:*;
            param1.vertices[_loc5_ = _loc4_++] = this.data.readFloat();
            var _loc6_:*;
            param1.vertices[_loc6_ = _loc4_++] = this.data.readFloat();
            var _loc7_:*;
            param1.vertices[_loc7_ = _loc4_++] = this.data.readFloat();
            _loc3_++;
         }
      }
      ...
      private function parseUVs(param1:ObjectData) : void
      {
         ...
         {
            var _loc5_:*;
            param1.uvs[_loc5_ = _loc4_++] = this.data.readFloat();
            var _loc6_:*;
            param1.uvs[_loc6_ = _loc4_++] = this.data.readFloat();
            _loc3_++;
         }
      }
      ...
      {
         var _loc3_:int = int(this.data.readUnsignedShort());
         ...
         {
            var _loc7_:*;
            param1.faces[_loc7_ = _loc5_++] = this.data.readUnsignedShort();
            var _loc8_:*;
            param1.faces[_loc8_ = _loc5_++] = this.data.readUnsignedShort();
            var _loc9_:*;
            param1.faces[_loc9_ = _loc5_++] = this.data.readUnsignedShort();
      ...
      private function buildContent(param1:String, param2:Number) : void
      {
         ...
         for(_loc3_ in this.materialDatas)
         {
            ...
            if((_loc8_ = _loc7_.diffuseMap) != null)
            {
               _loc9_ = new Matrix();
               ...
               (_loc11_ = new TextureMaterial()).name = _loc3_;
         ...
         if(this.animationDatas != null)
         {
            if(this.objectDatas != null)
            {
               _loc14_ = int(this.animationDatas.length);
               _loc13_ = 0;
      ...
      private function buildMesh(param1:Mesh, param2:ObjectData, param3:AnimationData, param4:Number) : void
      {
         ...
         if(param3 != null)
         {
            ...
            _loc27_ = param2.k;
            _loc28_ = param2.l;
            _loc29_ = 1 / (-_loc19_ * _loc22_ * _loc25_ + _loc18_ * _loc23_ * _loc25_ + _loc19_ * _loc21_ * _loc26_ - _loc17_ * _loc23_ * _loc26_ - _loc18_ * _loc21_ * _loc27_ + _loc17_ * _loc22_ * _loc27_);
            param2.a = (-_loc23_ * _loc26_ + _loc22_ * _loc27_) * _loc29_;
            param2.b = (_loc19_ * _loc26_ - _loc18_ * _loc27_) * _loc29_;
            param2.c = (-_loc19_ * _loc22_ + _loc18_ * _loc23_) * _loc29_;
            param2.d = (_loc20_ * _loc23_ * _loc26_ - _loc19_ * _loc24_ * _loc26_ - _loc20_ * _loc22_ * _loc27_ + _loc18_ * _loc24_ * _loc27_ + _loc19_ * _loc22_ * _loc28_ - _loc18_ * _loc23_ * _loc28_) * _loc29_;
            param2.e = (_loc23_ * _loc25_ - _loc21_ * _loc27_) * _loc29_;
            param2.f = (-_loc19_ * _loc25_ + _loc17_ * _loc27_) * _loc29_;
            param2.g = (_loc19_ * _loc21_ - _loc17_ * _loc23_) * _loc29_;
            param2.h = (_loc19_ * _loc24_ * _loc25_ - _loc20_ * _loc23_ * _loc25_ + _loc20_ * _loc21_ * _loc27_ - _loc17_ * _loc24_ * _loc27_ - _loc19_ * _loc21_ * _loc28_ + _loc17_ * _loc23_ * _loc28_) * _loc29_;
            param2.i = (-_loc22_ * _loc25_ + _loc21_ * _loc26_) * _loc29_;
            param2.j = (_loc18_ * _loc25_ - _loc17_ * _loc26_) * _loc29_;
            param2.k = (-_loc18_ * _loc21_ + _loc17_ * _loc22_) * _loc29_;
            param2.l = (_loc20_ * _loc22_ * _loc25_ - _loc18_ * _loc24_ * _loc25_ - _loc20_ * _loc21_ * _loc26_ + _loc17_ * _loc24_ * _loc26_ + _loc18_ * _loc21_ * _loc28_ - _loc17_ * _loc22_ * _loc28_) * _loc29_;
         ...
         var _loc14_:Boolean = param2.uvs != null && param2.uvs.length > 0;
         _loc9_ = 0;
         _loc10_ = 0;
         while(_loc9_ < param2.vertices.length)
         {
            _loc12_ = new Vertex();
            if(_loc13_)
            {
               ...
               _loc32_ = param2.vertices[_loc9_++];
            ...
            _loc12_.alternativa3d::transformId = -1;
            var _loc40_:*;
            _loc5_[_loc40_ = _loc7_++] = _loc12_;
            _loc12_.alternativa3d::next = param1.alternativa3d::vertexList;
            param1.alternativa3d::vertexList = _loc12_;
         }
         _loc10_ = 0;
         _loc9_ = 0;
         while(_loc9_ < param2.faces.length)
         {
            (_loc11_ = new Face()).alternativa3d::wrapper = new Wrapper();
            _loc11_.alternativa3d::wrapper.alternativa3d::next = new Wrapper();
            _loc11_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next = new Wrapper();
            _loc11_.alternativa3d::wrapper.alternativa3d::vertex = _loc5_[param2.faces[_loc9_++]];
            _loc11_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::vertex = _loc5_[param2.faces[_loc9_++]];
            _loc11_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::vertex = _loc5_[param2.faces[_loc9_++]];
            _loc11_.smoothingGroups = param2.smoothingGroups[_loc10_++];
            _loc6_[_loc40_ = _loc8_++] = _loc11_;
            if(_loc15_ != null)
            {
               _loc15_.alternativa3d::next = _loc11_;
            }
            else
            {
               param1.alternativa3d::faceList = _loc11_;
            }
            _loc15_ = _loc11_;
         }
         if(param2.surfaces != null)
         {
            for(_loc33_ in param2.surfaces)
            {
               ...
               {
                  (_loc11_ = _loc6_[_loc34_[_loc9_]]).material = _loc36_;
                  if(_loc35_.matrix != null)
                  {
                     _loc37_ = _loc11_.alternativa3d::wrapper;
                     while(_loc37_ != null)
                     {
                        _loc12_ = _loc37_.alternativa3d::vertex;
                        if(_loc12_.alternativa3d::transformId < 0)
                        {
                           _loc38_ = _loc12_.u;
                           _loc39_ = _loc12_.v;
                           ...
                           _loc12_.alternativa3d::transformId = 0;
                        }
                        _loc37_ = _loc37_.alternativa3d::next;
                     }
                  }
                  _loc9_++;
               }
         ...
         var _loc16_:FillMaterial;
         (_loc16_ = new FillMaterial(8355711)).name = "default";
         _loc11_ = param1.alternativa3d::faceList;
         while(_loc11_ != null)
         {
            if(_loc11_.material == null)
            {
               _loc11_.material = _loc16_;
            }
      ...
      private function getString(param1:int) : String
      {
         ...
         this.data.position = param1;
         var _loc3_:String = "";
         while(_loc2_ = this.data.readByte(), _loc2_ != 0)
         {
