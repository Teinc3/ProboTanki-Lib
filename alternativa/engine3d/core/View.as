package alternativa.engine3d.core
{
   ...
   public class View extends Canvas
   {
      ...
      private function onRemoveFromStage(param1:Event) : void
      {
         ...
         var _loc2_:int = int(views.indexOf(this));
      ...
      alternativa3d function configure() : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:View = null;
         var _loc7_:int = stage.quality == "LOW" ? int(0) : (stage.quality == "MEDIUM" ? int(2) : int(4));
         var _loc8_:int = this.antiAliasEnabled && !this.alternativa3d::constrained ? int(_loc7_) : int(0);
         this.alternativa3d::quality = _loc7_ > 0;
         if(!configured)
         {
            _loc1_ = 1000000;
            _loc2_ = 1000000;
            ...
            _loc4_ = -1000000;
            _loc5_ = 0;
            while(_loc5_ < views.length)
            {
               _loc6_ = views[_loc5_];
               coords.x = 0;
               coords.y = 0;
               _loc6_.globalCoords = _loc6_.localToGlobal(coords);
               if(_loc6_.globalCoords.x < _loc1_)
               {
                  _loc1_ = _loc6_.globalCoords.x;
               }
               if(_loc6_.globalCoords.y < _loc2_)
               {
                  _loc2_ = _loc6_.globalCoords.y;
               }
               if(_loc6_.globalCoords.x + _loc6_.alternativa3d::_width > _loc3_)
               {
                  _loc3_ = _loc6_.globalCoords.x + _loc6_.alternativa3d::_width;
               }
               if(_loc6_.globalCoords.y + _loc6_.alternativa3d::_height > _loc4_)
               {
                  _loc4_ = _loc6_.globalCoords.y + _loc6_.alternativa3d::_height;
               }
               _loc5_++;
            }
            this.alternativa3d::device.x = _loc1_;
            this.alternativa3d::device.y = _loc2_;
            this.alternativa3d::device.width = _loc3_ - _loc1_;
            this.alternativa3d::device.height = _loc4_ - _loc2_;
            this.alternativa3d::device.antiAlias = _loc8_;
      ...
      private function processOverOut() : void
      {
         ...
         var _loc5_:int = int(branch.length);
         var _loc6_:int = int(overedBranch.length);
         if(this.overedTarget != null)
         {
            ...
            while(_loc2_ < _loc6_)
            {
               _loc4_ = overedBranch[_loc2_];
               _loc3_ = 0;
               while(_loc3_ < _loc5_)
               {
                  if(_loc4_ == branch[_loc3_])
                  {
                     break;
                  }
                  _loc3_++;
         ...
         if(this.target != null)
         {
            ...
            while(_loc2_ < _loc5_)
            {
               _loc4_ = branch[_loc2_];
               _loc3_ = 0;
               while(_loc3_ < _loc6_)
               {
                  if(_loc4_ == overedBranch[_loc3_])
                  {
                     break;
                  }
                  _loc3_++;
      ...
      private function propagateEvent(param1:String, param2:Object3D, param3:Vector.<Object3D>, param4:Boolean = true, param5:Object3D = null) : void
      {
         ...
         var _loc7_:Vector.<Function> = null;
         var _loc8_:int = 0;
         var _loc9_:int = 0;
         var _loc10_:int = 0;
         var _loc11_:MouseEvent3D = null;
         var _loc12_:int = int(param3.length);
         _loc9_ = _loc12_ - 1;
         while(_loc9_ > 0)
         {
            _loc6_ = param3[_loc9_];
            if(_loc6_.alternativa3d::captureListeners != null)
            {
               _loc7_ = _loc6_.alternativa3d::captureListeners[param1];
               if(_loc7_ != null)
               {
                  if(_loc11_ == null)
                  {
                     (_loc11_ = new MouseEvent3D(param1,param4,param5,this.altKey,this.ctrlKey,this.shiftKey,this.buttonDown,this.delta)).alternativa3d::_target = param2;
                     _loc11_.alternativa3d::calculateLocalRay(mouseX,mouseY,param2,this.alternativa3d::camera);
                  }
                  _loc11_.alternativa3d::_currentTarget = _loc6_;
                  _loc11_.alternativa3d::_eventPhase = 1;
                  _loc8_ = int(_loc7_.length);
                  _loc10_ = 0;
                  while(_loc10_ < _loc8_)
                  {
                     functions[_loc10_] = _loc7_[_loc10_];
                     _loc10_++;
                  }
                  _loc10_ = 0;
                  while(_loc10_ < _loc8_)
                  {
                     (functions[_loc10_] as Function).call(null,_loc11_);
                     if(_loc11_.alternativa3d::stopImmediate)
                     {
                        return;
                     }
                     _loc10_++;
                  }
                  if(_loc11_.alternativa3d::stop)
                  {
                     return;
                  }
               }
         ...
         {
            _loc6_ = param3[_loc9_];
            if(_loc6_.alternativa3d::bubbleListeners != null)
            {
               _loc7_ = _loc6_.alternativa3d::bubbleListeners[param1];
               if(_loc7_ != null)
               {
                  if(_loc11_ == null)
                  {
                  ...
                  _loc11_.alternativa3d::_currentTarget = _loc6_;
                  _loc11_.alternativa3d::_eventPhase = _loc9_ == 0 ? uint(2) : uint(3);
                  _loc8_ = int(_loc7_.length);
                  _loc10_ = 0;
                  while(_loc10_ < _loc8_)
                  {
      ...
      private function defineTarget(param1:MouseEvent) : void
      {
         ...
         while(_loc5_ >= 0)
         {
            ...
            while(_loc3_.parent != stage)
            {
               _loc2_ = _loc3_ as Canvas;
               if(_loc2_ != null)
               {
                  break;
               }
