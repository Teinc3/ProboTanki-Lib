package alternativa.physics.collision.colliders
{
   ...
   public class BoxRectCollider implements Collider
   {
      ...
      public function haveCollision(param1:CollisionShape, param2:CollisionShape, param3:Boolean = false) : Boolean
      {
         ...
         var _loc5_:CollisionRect = null;
         this.minOverlap = 10000000000;
         if(param1 is CollisionBox)
         {
            _loc4_ = CollisionBox(param1);
            _loc5_ = CollisionRect(param2);
         }
         else
         {
            _loc4_ = CollisionBox(param2);
            _loc5_ = CollisionRect(param1);
         }
         var _loc6_:Matrix4 = _loc4_.transform;
         var _loc7_:Matrix4 = _loc5_.transform;
         this._vectorToBox.x = _loc6_.m03 - _loc7_.m03;
         this._vectorToBox.y = _loc6_.m13 - _loc7_.m13;
         this._vectorToBox.z = _loc6_.m23 - _loc7_.m23;
         this.axis22.x = _loc7_.m02;
         this.axis22.y = _loc7_.m12;
         this.axis22.z = _loc7_.m22;
         if(!this.testMainAxis(_loc4_,_loc5_,this.axis22,this._vectorToBox))
         {
            return false;
         }
         ...
         if(!this.testMainAxis(_loc4_,_loc5_,this.axis10,this._vectorToBox))
         {
            return false;
         }
         ...
         if(!this.testMainAxis(_loc4_,_loc5_,this.axis11,this._vectorToBox))
         {
            return false;
         }
         ...
         if(!this.testMainAxis(_loc4_,_loc5_,this.axis12,this._vectorToBox))
         {
            return false;
         }
         this.axis20.x = _loc7_.m00;
         this.axis20.y = _loc7_.m10;
         this.axis20.z = _loc7_.m20;
         this.axis21.x = _loc7_.m01;
         this.axis21.y = _loc7_.m11;
         this.axis21.z = _loc7_.m21;
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis10,this.axis20,this._vectorToBox))
         {
            return false;
         }
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis10,this.axis21,this._vectorToBox))
         {
            return false;
         }
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis11,this.axis20,this._vectorToBox))
         {
            return false;
         }
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis11,this.axis21,this._vectorToBox))
         {
            return false;
         }
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis12,this.axis20,this._vectorToBox))
         {
            return false;
         }
         if(!this.testDerivedAxis(_loc4_,_loc5_,this.axis12,this.axis21,this._vectorToBox))
         {
            return false;
         }
         return true;
      ...
      private function getOverlapOnAxis(param1:CollisionBox, param2:CollisionRect, param3:Vector3, param4:Vector3) : Number
      {
         ...
         var _loc6_:Number;
         if((_loc6_ = (_loc5_.m00 * param3.x + _loc5_.m10 * param3.y + _loc5_.m20 * param3.z) * param1.hs.x) < 0)
         {
            _loc6_ = -_loc6_;
         }
         ...
         if((_loc6_ = (_loc5_.m00 * param3.x + _loc5_.m10 * param3.y + _loc5_.m20 * param3.z) * param2.hs.x) < 0)
         {
            _loc6_ = -_loc6_;
         }
         _loc7_ += _loc6_;
      ...
      private function findContacts(param1:CollisionBox, param2:CollisionRect, param3:Vector3, param4:Vector.<ShapeContact>) : void
      {
         ...
         var _loc12_:Vector3;
         (_loc12_ = this._vectorToBox).x = _loc5_.m03 - _loc11_.m03;
