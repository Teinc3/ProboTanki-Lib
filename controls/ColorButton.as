package controls
{
   ...
   public class ColorButton extends Renamed3959
   {
      ...
      public function setStyle(param1:String = "def") : void
      {
         ...
         var _loc3_:* = "button_" + param1 + "_";
         _loc2_ = "UP";
         this.stateUP.bmpLeft = this.getBitmapByName(_loc3_ + _loc2_ + "_LEFT");
         this.stateUP.bmpCenter = this.getBitmapByName(_loc3_ + _loc2_ + "_CENTER");
         this.stateUP.bmpRight = this.getBitmapByName(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "OVER";
         this.stateOVER.bmpLeft = this.getBitmapByName(_loc3_ + _loc2_ + "_LEFT");
         this.stateOVER.bmpCenter = this.getBitmapByName(_loc3_ + _loc2_ + "_CENTER");
         this.stateOVER.bmpRight = this.getBitmapByName(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "DOWN";
         this.stateDOWN.bmpLeft = this.getBitmapByName(_loc3_ + _loc2_ + "_LEFT");
         this.stateDOWN.bmpCenter = this.getBitmapByName(_loc3_ + _loc2_ + "_CENTER");
         this.stateDOWN.bmpRight = this.getBitmapByName(_loc3_ + _loc2_ + "_RIGHT");
         _loc2_ = "OFF";
         _loc3_ = "button_";
         this.stateOFF.bmpLeft = this.getBitmapByName(_loc3_ + _loc2_ + "_LEFT");
         this.stateOFF.bmpCenter = this.getBitmapByName(_loc3_ + _loc2_ + "_CENTER");
         this.stateOFF.bmpRight = this.getBitmapByName(_loc3_ + _loc2_ + "_RIGHT");
         this.width = 96;
      }
