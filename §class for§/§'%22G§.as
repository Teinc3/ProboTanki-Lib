package §class for§
{
   ...
   public class §'"G§ extends §["D§ implements §finally const package§
   {
      private var container:§6!<§;
      
      private var trail:§break const extends§;
      ...
      public function §'"G§(param1:§1Q§)
      {
         this.§const with§ = new Vector3();
         this.direction = new Vector3();
         super(param1);
         this.trail = new §break const extends§();
      }
      ...
      public function play(param1:int, param2:§3!0§) : Boolean
      {
         ...
         §null catch while§.§native var static§(this.trail,this.§const with§,this.direction,param2.position);
         _loc4_ = this.time / this.§function catch import§;
         _loc3_ = Math.sqrt(_loc4_);
         this.trail.scaleX = this.§throw set final§ + (this.§switch false§ - this.§throw set final§) * _loc3_;
