package §class for§
{
   internal class §break const extends§ extends Mesh
   {
      ...
      private var §return var finally§:Number;
      
      private var §include for else§:Number;
      
      public function §break const extends§()
      {
         super();
      ...
      public function init(param1:Number, param2:Number, param3:Material, param4:Number) : void
      {
         ...
         {
            this.§return var finally§ = param2 / (param1 * _loc6_.texture.height / _loc6_.texture.width);
            this.§include for else§ = param4 / param1;
         }
         else
         {
            this.§return var finally§ = 1;
            this.§include for else§ = 0;
         }
      }
      ...
      {
         var _loc2_:Number = this.§include for else§ * param1;
         this.a.v = _loc2_;
         this.b.v = this.§return var finally§ + _loc2_;
         this.c.v = this.§return var finally§ + _loc2_;
         this.d.v = _loc2_;
      }
   }
}
