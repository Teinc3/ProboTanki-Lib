package §class for§
{
   ...
   public class §'#`§
   {
      private static const §finally for const§:int = 210;
      
      private static const §const package finally§:int = 30;
      ...
      private static function §implements package dynamic§(param1:ImageResource, param2:ImageResource, param3:ImageResource) : String
      {
      ...
      private static function createTexture(param1:ImageResource, param2:ImageResource, param3:ImageResource) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(§finally for const§ * §const package finally§,§finally for const§,true,0);
         var _loc8_:String = BlendMode.NORMAL;
         var _loc9_:int = 0;
         while(_loc9_ < §const package finally§)
         {
            §+'§(_loc4_,_loc7_,_loc9_,§finally for const§,_loc8_);
            §1A§(_loc5_,_loc7_,_loc9_,§finally for const§,_loc8_);
            §7!x§(_loc6_,_loc7_,_loc9_,§finally for const§,_loc8_);
            _loc9_++;
         }
         return _loc7_;
      }
      ...
      private static function §1A§(param1:BitmapData, param2:BitmapData, param3:int, param4:int, param5:String) : void
      {
         var _loc6_:ColorTransform = new ColorTransform();
         if(param3 < 5)
         {
      ...
      private static function §7!x§(param1:BitmapData, param2:BitmapData, param3:int, param4:int, param5:String) : void
      {
      ...
      {
         var _loc4_:§true set while§ = this.§return const in§(param1,param2,param3);
         ++_loc4_.§@#;§;
         return _loc4_.texture;
      }
      
      public function §const for set§(param1:ImageResource, param2:ImageResource, param3:ImageResource) : void
      {
         var _loc4_:String = §implements package dynamic§(param1,param2,param3);
         var _loc5_:§true set while§ = this.cache[_loc4_];
         if(_loc5_ != null)
         {
            --_loc5_.§@#;§;
            if(_loc5_.§@#;§ == 0)
      ...
      private function §return const in§(param1:ImageResource, param2:ImageResource, param3:ImageResource) : §true set while§
      {
         var _loc4_:String = §implements package dynamic§(param1,param2,param3);
         var _loc5_:§true set while§ = this.cache[_loc4_];
         if(_loc5_ == null)
         {
            (_loc5_ = new §true set while§()).texture = createTexture(param1,param2,param3);
