package §?#>§
{
   ...
   public class §catch catch return§ extends BlackRoundRect
   {
      [Inject]
      ...
      private static const §=W§:Class = §static set continue§;
      ...
      public function §catch catch return§()
      {
         super();
         this.init();
      }
      ...
      private function init() : void
      {
         ...
         var _loc4_:int = 5;
         var _loc5_:int = 16;
         var _loc6_:Bitmap = new Bitmap(new §=W§().bitmapData);
         addChild(_loc6_);
         _loc6_.y = _loc2_ - 5;
