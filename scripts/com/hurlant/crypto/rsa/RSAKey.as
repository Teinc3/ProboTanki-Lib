package com.hurlant.crypto.rsa
{
   ...
   public class RSAKey
   {
      ...
      public static function generate(param1:uint, param2:String) : RSAKey
      {
         ...
         while(_loc9_ = _loc7_.multiply(_loc8_), _loc9_.gcd(_loc6_).compareTo(BigInteger.ONE) != 0);
         ...
         _loc5_.canEncrypt = _loc5_.n != null && _loc5_.e != 0;
         _loc5_.canDecrypt = _loc5_.canEncrypt && _loc5_.d != null;
         return _loc5_;
      }
      ...
      private function _encrypt(param1:Function, param2:ByteArray, param3:ByteArray, param4:uint, param5:Function, param6:int) : void
      {
         ...
         while(param2.position < _loc8_)
         {
            ...
            _loc11_ = _loc7_ - Math.ceil(_loc10_.bitLength() / 8);
            while(_loc11_ > 0)
            {
               param3.writeByte(0);
               _loc11_--;
      ...
      private function pkcs1pad(param1:ByteArray, param2:int, param3:uint, param4:uint = 2) : ByteArray
      {
         ...
         if(param4 == 2)
         {
            ...
            while(param3 > 2)
            {
               while(_loc9_ = _loc8_.nextByte(), _loc9_ == 0)
               {
               }
               var _loc11_:*;
      ...
      private function pkcs1unpad(param1:BigInteger, param2:uint, param3:uint = 2) : ByteArray
      {
         ...
         var _loc5_:ByteArray = new ByteArray();
         param1.toArray(_loc5_);
         _loc5_.position = 0;
         var _loc6_:int = 0;
         while(_loc6_ < _loc5_.length && _loc5_[_loc6_] == 0)
         {
            _loc6_++;
         }
         if(_loc5_.length - _loc6_ != param2 - 1 || _loc5_[_loc6_] != param3)
         {
            return null;
         }
         _loc6_++;
