package Renamed215
{
   ...
   public class Renamed5726
   {
      ...
      public function Renamed5726(param1:String, param2:String, param3:int, param4:Boolean, param5:Boolean, param6:Renamed663, param7:ChatModeratorLevel)
      {
         super();
         this._userId = param1;
         this._uid = param2;
      ...
      public function getShortUserInfo() : Renamed2611
      {
         var _loc1_:Renamed2611 = new Renamed2611();
         _loc1_.userId = this._userId;
         _loc1_.uid = this._uid;
         _loc1_.rank = this._rank;
         _loc1_.suspicious = this._suspicious;
         _loc1_.teamType = this.Renamed956;
