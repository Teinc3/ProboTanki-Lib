package Renamed438
{
   ...
   public class Renamed4793 extends Sprite
   {
      [Inject]
      ...
      public function Renamed4793(param1:int, param2:int, param3:KitItem, param4:int, param5:int)
      {
         var _loc12_:uint = 0;
         ...
         var _loc11_:Boolean = itemService.Renamed1773(_loc10_) && !itemService.isCountable(_loc10_) && itemService.getCategory(_loc10_) != ItemCategoryEnum.PLUGIN;
         _loc12_ = !_loc11_ ? uint(16777215) : uint(9539985);
         var _loc13_:LabelBase;
         (_loc13_ = new LabelBase()).color = _loc12_;
         ...
         var _loc14_:Diamond;
         (_loc14_ = new Diamond()).x = _loc9_ - _loc13_.x - _loc14_.width;
         addChild(_loc14_);
         _loc14_.y = param5;
         var _loc15_:int = itemService.getPriceWithoutDiscount(param3.item) * param3.count;
         var _loc16_:LabelBase;
         (_loc16_ = new LabelBase()).color = _loc12_;
