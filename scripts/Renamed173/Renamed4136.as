package Renamed4135
{
   ...
   public class Renamed4136 implements ICodec
   {
      private var elementCodec:ICodec;
      
      private var Renamed5009:Boolean;
      
      public function Renamed4136(param1:Boolean)
      {
         super();
      ...
      public function decode(param1:ProtocolBuffer) : Object
      {
         ...
         var _loc3_:Vector.<Long> = new Vector.<Long>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = Long(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc4_:Vector.<Long> = Vector.<Long>(param2);
