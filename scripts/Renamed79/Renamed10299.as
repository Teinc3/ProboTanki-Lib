package Renamed79
{
   ...
   public final class Renamed10299 extends Mesh
   {
      private static const Renamed10312:Class = final;
      
      private static const Renamed10313:Class = Renamed10314;
      
      private static const Renamed10315:BitmapData = new Renamed10312().bitmapData;
      
      private static const Renamed10316:BitmapData = new Renamed10313().bitmapData;
      
      private static const FADE:Number = 100;
      
      private static const WIDTH:Number = 10;
      
      private static const Renamed10317:Number = 5;
      
      private static const Renamed1632:Number = 0.5;
      
      private static const Renamed10318:Number = 0.75;
      
      private static const DELTA:Number = 300;
      
      private static const Renamed10319:Dictionary = new Dictionary();
      
      private static const Renamed10320:Dictionary = new Dictionary();
      ...
      {
         this.color = param1;
         this.material = Renamed3238.Renamed3888(Renamed10319,param1,Renamed10315);
         this.rayFace1.material = this.material;
         this.rayFace2.material = this.material;
         var _loc2_:TextureMaterial = Renamed3238.Renamed3888(Renamed10320,param1,Renamed10316,false);
         ...
         this.h2.u = 1;
         this.h2.v = 0;
         this.Renamed9268 = Renamed10317 * WIDTH * this.material.texture.height / this.material.texture.width;
         this.angle = 0;
         this.angle2 = 0;
      }
      ...
      public function update(param1:int, param2:Number) : void
      {
         ...
         this.g2.y = 0;
         this.h2.y = FADE;
         this.angle += Renamed1632 * _loc3_;
         this.angle2 += Renamed10318 * _loc3_;
         var _loc4_:Number = Math.sin(this.angle) * DELTA;
         var _loc5_:Number = Math.sin(this.angle2) * DELTA;
         this.a1.v = (-this.a1.y + _loc4_) / this.Renamed9268;
         this.b1.v = (-this.b1.y + _loc4_) / this.Renamed9268;
         this.c1.v = (-this.c1.y + _loc4_) / this.Renamed9268;
         this.d1.v = (-this.d1.y + _loc4_) / this.Renamed9268;
         this.a2.v = (-this.a2.y + _loc5_) / this.Renamed9268;
         this.b2.v = (-this.b2.y + _loc5_) / this.Renamed9268;
         this.c2.v = (-this.c2.y + _loc5_) / this.Renamed9268;
         this.d2.v = (-this.d2.y + _loc5_) / this.Renamed9268;
         ...
         var _loc10_:Number = (Renamed10315.getPixel(_loc8_,_loc9_) >> 16 & 0xFF) / 255;
         this.e1.v = 1 - _loc10_;
         this.h1.v = 1 - _loc10_;
         ...
         _loc10_ = (Renamed10315.getPixel(_loc8_,_loc9_) >> 16 & 0xFF) / 255;
         this.e2.v = 1 - _loc10_;
         this.h2.v = 1 - _loc10_;
      }
      ...
      {
         if(this.color in Renamed10319)
         {
            delete Renamed10319[this.color];
         }
         if(this.color in Renamed10320)
         {
            delete Renamed10320[this.color];
         }
         this.material = null;
