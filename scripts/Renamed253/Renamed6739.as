package Renamed253
{
   ...
   import alternativa.tanks.models.battle.gui.gui.statistics.field.score.ctf.Renamed2680;
   ...
   public class Renamed6739 extends Sprite implements Renamed2658
   {
      private static var Renamed2662:Class = Renamed6738;
      
      private static var Renamed2666:Class = Renamed6740;
      
      private static var Renamed2668:Class = Renamed6741;
      ...
      private var Renamed6742:BattleInfoIcons;
      ...
      public function Renamed6739()
      {
         ...
         this.Renamed6742 = new BattleInfoIcons();
         this.Renamed6742.type = BattleInfoIcons.Renamed3958;
         this.Renamed6742.y = 9;
         addChild(this.Renamed6742);
         this.update();
      ...
      {
         this.Renamed2677.setState(Renamed2657.Renamed2691);
      }
      
      public function showFlagDropped() : void
      {
         this.Renamed2677.setState(Renamed2657.Renamed2692);
      }
