package Renamed56
{
   internal class Renamed10053 extends Mesh
   {
      ...
      private var Renamed10092:Number;
      
      private var Renamed10093:Number;
      
      public function Renamed10053()
      {
         super();
      ...
      public function init(param1:Number, param2:Number, param3:Material, param4:Number) : void
      {
         ...
         {
            this.Renamed10092 = param2 / (param1 * _loc6_.texture.height / _loc6_.texture.width);
            this.Renamed10093 = param4 / param1;
         }
         else
         {
            this.Renamed10092 = 1;
      ...
      {
         var _loc2_:Number = this.Renamed10093 * param1;
         this.a.v = _loc2_;
         this.b.v = this.Renamed10092 + _loc2_;
         this.c.v = this.Renamed10092 + _loc2_;
         this.d.v = _loc2_;
      }
   }
}
