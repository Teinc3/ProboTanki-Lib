package Renamed4626
{
   ...
   public class Renamed4627 extends BlackRoundRect
   {
      [Inject]
      ...
      private static const Renamed5685:Class = Renamed5686;
      ...
      private function init() : void
      {
         ...
         var _loc4_:int = 5;
         var _loc5_:int = 16;
         _loc6_ = new Bitmap(new Renamed5685().bitmapData);
         addChild(_loc6_);
         _loc6_.y = _loc2_ - 5;
