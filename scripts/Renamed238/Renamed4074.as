package Renamed238
{
   ...
   public class Renamed4074 implements ICodec
   {
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.Renamed6550 = param1.getCodec(new TypeCodecInfo(Number,false));
      }
      
      public function decode(param1:ProtocolBuffer) : Object
      {
         var _loc2_:Renamed4059 = new Renamed4059();
         _loc2_.key = this.Renamed6549.decode(param1) as String;
         _loc2_.value = this.Renamed6550.decode(param1) as Number;
         return _loc2_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Renamed4059 = Renamed4059(param2);
