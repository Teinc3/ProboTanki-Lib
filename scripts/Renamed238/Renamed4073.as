package Renamed238
{
   ...
   public class Renamed4073 implements ICodec
   {
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.Renamed6550 = param1.getCodec(new TypeCodecInfo(int,false));
      }
      
      public function decode(param1:ProtocolBuffer) : Object
      {
         var _loc2_:Renamed4061 = new Renamed4061();
         _loc2_.key = this.Renamed6549.decode(param1) as String;
         _loc2_.value = this.Renamed6550.decode(param1) as int;
         return _loc2_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Renamed4061 = Renamed4061(param2);
