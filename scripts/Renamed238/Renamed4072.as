package Renamed238
{
   ...
   public class Renamed4072 implements ICodec
   {
      ...
      public function init(param1:IProtocol) : void
      {
         ...
         this.Renamed6550 = param1.getCodec(new TypeCodecInfo(Boolean,false));
      }
      
      public function decode(param1:ProtocolBuffer) : Object
      {
         var _loc2_:Renamed4057 = new Renamed4057();
         _loc2_.key = this.Renamed6549.decode(param1) as String;
         _loc2_.value = this.Renamed6550.decode(param1) as Boolean;
         return _loc2_;
      }
      ...
      public function encode(param1:ProtocolBuffer, param2:Object) : void
      {
         ...
         var _loc3_:Renamed4057 = Renamed4057(param2);
