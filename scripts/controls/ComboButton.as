package controls
{
   ...
   {
      public var stateUP:ComboButtonState;
      
      public var stateOVER:ComboButtonState;
      
      public var stateDOWN:ComboButtonState;
      
      public var stateOFF:ComboButtonState;
      ...
      {
         this.stateUP = new ComboUpButton();
         this.stateOVER = new ComboOverButton();
         this.stateDOWN = new ComboDownButton();
         this.stateOFF = new ComboOffButton();
