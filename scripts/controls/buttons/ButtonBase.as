package controls.buttons
{
   ...
   public class ButtonBase extends DiscreteSprite
   {
      ...
      protected var _innerLayer:DiscreteSprite;
      
      private var state2view:Dictionary;
      
      private var currentState:ButtonStates;
      
      public function ButtonBase(param1:DisplayObject, param2:DisplayObject, param3:DisplayObject, param4:DisplayObject)
      {
         this._label = new Label();
         this._innerLayer = new DiscreteSprite();
         this.state2view = new Dictionary();
         this.currentState = ButtonStates.UP;
         super();
         this.upState = param1;
