package scpacker.networking.protocol.codec.custom
{
   ...
   public class VectorCodecBattleMine implements ICodec
   {
      ...
      public function VectorCodecBattleMine(param1:CodecRegisterer)
      {
         super();
      ...
      public function decode(param1:ByteArray) : Object
      {
         ...
         var _loc3_:Vector.<Renamed7757> = new Vector.<Renamed7757>(_loc2_,true);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_)
         {
            _loc3_[_loc4_] = Renamed7757(this.elementCodec.decode(param1));
            _loc4_++;
         }
         return _loc3_;
      }
      ...
      public function encode(param1:ByteArray, param2:Object) : int
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:Vector.<Renamed7757> = Vector.<Renamed7757>(param2);
