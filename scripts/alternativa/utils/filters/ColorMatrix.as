package alternativa.utils.filters
{
   public class ColorMatrix extends DynamicMatrix
   {
      ...
      public function SetHueMatrix(param1:Number) : void
      {
         ...
         var _loc8_:Number = 0.213;
         var _loc9_:Number = 0.715;
         var _loc10_:Number = 0.072;
         _loc3_.SetValue(0,0,_loc8_);
         _loc3_.SetValue(1,0,_loc8_);
         _loc3_.SetValue(2,0,_loc8_);
         _loc3_.SetValue(0,1,_loc9_);
         _loc3_.SetValue(1,1,_loc9_);
         _loc3_.SetValue(2,1,_loc9_);
         _loc3_.SetValue(0,2,_loc10_);
         _loc3_.SetValue(1,2,_loc10_);
         _loc3_.SetValue(2,2,_loc10_);
         _loc4_.SetValue(0,0,1 - _loc8_);
         _loc4_.SetValue(1,0,-_loc8_);
         _loc4_.SetValue(2,0,-_loc8_);
         _loc4_.SetValue(0,1,-_loc9_);
         _loc4_.SetValue(1,1,1 - _loc9_);
         _loc4_.SetValue(2,1,-_loc9_);
         _loc4_.SetValue(0,2,-_loc10_);
         _loc4_.SetValue(1,2,-_loc10_);
         _loc4_.SetValue(2,2,1 - _loc10_);
         _loc4_.MultiplyNumber(_loc6_);
         _loc5_.SetValue(0,0,-_loc8_);
         _loc5_.SetValue(1,0,0.143);
         _loc5_.SetValue(2,0,-(1 - _loc8_));
         _loc5_.SetValue(0,1,-_loc9_);
         _loc5_.SetValue(1,1,0.14);
         _loc5_.SetValue(2,1,_loc9_);
         _loc5_.SetValue(0,2,1 - _loc10_);
         _loc5_.SetValue(1,2,-0.283);
         _loc5_.SetValue(2,2,_loc10_);
         _loc5_.MultiplyNumber(_loc7_);
         _loc3_.Add(_loc4_);
         _loc3_.Add(_loc5_);
         var _loc11_:int = 0;
         while(_loc11_ < 3)
         {
            ...
            while(_loc2_ < 3)
            {
               m_matrix[_loc11_][_loc2_] = _loc3_.GetValue(_loc11_,_loc2_);
               _loc2_++;
            }
            _loc11_++;
         }
      ...
      public function GetFlatArray() : Array
      {
         ...
         while(_loc4_ < 4)
         {
            ...
            while(_loc1_ < 5)
            {
               _loc2_[_loc3_] = m_matrix[_loc4_][_loc1_];
               _loc3_++;
               _loc1_++;
            }
            _loc4_++;
