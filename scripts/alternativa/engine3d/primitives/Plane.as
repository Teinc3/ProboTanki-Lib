   ...
   public class Plane extends Mesh
   {
      public function Plane(param1:Number = 100, param2:Number = 100, param3:uint = 1, param4:uint = 1, param5:Boolean = true, param6:Boolean = false, param7:Boolean = false, param8:Material = null, param9:Material = null)
      {
         ...
         while(_loc10_ < _loc13_)
         {
            ...
            {
               var _loc23_:*;
               _loc21_[_loc23_ = _loc22_++] = this.createVertex(_loc10_ * _loc19_ - _loc15_,_loc11_ * _loc20_ - _loc16_,0,_loc10_ * _loc17_,(param4 - _loc11_) * _loc18_);
               _loc11_++;
            }
            _loc10_++;
         }
         ...
         if(param5)
         {
            ...
            while(_loc10_ < _loc13_)
            {
               ...
               while(_loc11_ < _loc14_)
               {
                  _loc21_[_loc23_ = _loc22_++] = this.createVertex(_loc10_ * _loc19_ - _loc15_,_loc11_ * _loc20_ - _loc16_,0,(param3 - _loc10_) * _loc17_,(param4 - _loc11_) * _loc18_);
                  _loc11_++;
               }
               _loc10_++;
            }
