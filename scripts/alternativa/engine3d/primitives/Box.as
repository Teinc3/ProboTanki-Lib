   ...
   public class Box extends Mesh
   {
      public function Box(param1:Number = 100, param2:Number = 100, param3:Number = 100, param4:uint = 1, param5:uint = 1, param6:uint = 1, param7:Boolean = false, param8:Boolean = false, param9:Material = null, param10:Material = null, param11:Material = null, param12:Material = null, param13:Material = null, param14:Material = null)
      {
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            {
               var _loc33_:*;
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc16_ * _loc28_ - _loc22_,-_loc23_,(param4 - _loc15_) * _loc24_,(param5 - _loc16_) * _loc25_);
               _loc16_++;
            }
            _loc15_++;
         }
         ...
         var _loc32_:uint = uint(_loc18_ * _loc19_);
         _loc15_ = 0;
         while(_loc15_ < _loc18_)
         {
            _loc16_ = 0;
            while(_loc16_ < _loc19_)
            {
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc16_ * _loc28_ - _loc22_,_loc23_,_loc15_ * _loc24_,(param5 - _loc16_) * _loc25_);
               _loc16_++;
            }
            _loc15_++;
         }
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            {
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,-_loc22_,_loc17_ * _loc29_ - _loc23_,_loc15_ * _loc24_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc15_++;
         }
         ...
         while(_loc15_ < _loc18_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(_loc15_ * _loc27_ - _loc21_,_loc22_,_loc17_ * _loc29_ - _loc23_,(param4 - _loc15_) * _loc24_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc15_++;
         }
         ...
         while(_loc16_ < _loc19_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(-_loc21_,_loc16_ * _loc28_ - _loc22_,_loc17_ * _loc29_ - _loc23_,(param5 - _loc16_) * _loc25_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc16_++;
         }
         ...
         while(_loc16_ < _loc19_)
         {
            ...
            while(_loc17_ < _loc20_)
            {
               _loc30_[_loc33_ = _loc31_++] = this.createVertex(_loc21_,_loc16_ * _loc28_ - _loc22_,_loc17_ * _loc29_ - _loc23_,_loc16_ * _loc25_,(param6 - _loc17_) * _loc26_);
               _loc17_++;
            }
            _loc16_++;
         }
      ...
      private function createFace(param1:Vertex, param2:Vertex, param3:Vertex, param4:Vertex, param5:Number, param6:Number, param7:Number, param8:Number, param9:Boolean, param10:Boolean, param11:Material) : void
      {
         ...
         if(param10)
         {
            (_loc13_ = new Face()).material = param11;
            _loc13_.alternativa3d::wrapper = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::vertex = param1;
            _loc13_.alternativa3d::wrapper.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::vertex = param2;
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::vertex = param3;
            _loc13_.alternativa3d::normalX = param5;
            _loc13_.alternativa3d::normalY = param6;
            _loc13_.alternativa3d::normalZ = param7;
            _loc13_.alternativa3d::offset = param8;
            _loc13_.alternativa3d::next = alternativa3d::faceList;
            alternativa3d::faceList = _loc13_;
            (_loc13_ = new Face()).material = param11;
            _loc13_.alternativa3d::wrapper = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::vertex = param1;
            _loc13_.alternativa3d::wrapper.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::vertex = param3;
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::vertex = param4;
            _loc13_.alternativa3d::normalX = param5;
            _loc13_.alternativa3d::normalY = param6;
            _loc13_.alternativa3d::normalZ = param7;
            _loc13_.alternativa3d::offset = param8;
         ...
         else
         {
            ...
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::vertex = param3;
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::next = new Wrapper();
            _loc13_.alternativa3d::wrapper.alternativa3d::next.alternativa3d::next.alternativa3d::next.alternativa3d::vertex = param4;
            _loc13_.alternativa3d::normalX = param5;
            _loc13_.alternativa3d::normalY = param6;
            _loc13_.alternativa3d::normalZ = param7;
            _loc13_.alternativa3d::offset = param8;
