package alternativa.tanks.services.colortransform
{
   ...
   public class Renamed1637
   {
      public function Renamed1637()
      {
         super();
      }
      
      public static function Renamed1641(param1:BitmapData, param2:ColorTransform) : BitmapData
      {
      ...
      public static function Renamed1644(param1:ColorTransform, param2:ColorTransform) : Boolean
      {
         if(param1 == param2)
         {
            return true;
      ...
      public static function Renamed2473(param1:Renamed2405, param2:Number) : ColorTransform
      {
         var _loc3_:Renamed770 = null;
         var _loc4_:Renamed770 = null;
         ...
         {
            _loc3_ = new Renamed770(param1.lightColor);
            _loc4_ = new Renamed770(param1.shadowColor);
            ...
            _loc8_ = (_loc4_.Renamed772() >> 16 & 0xFF) / 255;
            _loc9_ = (_loc4_.Renamed772() >> 8 & 0xFF) / 255;
            _loc10_ = (_loc4_.Renamed772() & 0xFF) / 255;
            _loc11_ = (_loc3_.Renamed772() >> 16 & 0xFF) / 255;
            _loc12_ = (_loc3_.Renamed772() >> 8 & 0xFF) / 255;
            _loc13_ = (_loc3_.Renamed772() & 0xFF) / 255;
            (_loc14_ = new ColorTransform()).redMultiplier = 2 * (_loc8_ + _loc11_ * _loc7_);
