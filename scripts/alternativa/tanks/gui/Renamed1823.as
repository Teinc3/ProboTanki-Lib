package alternativa.tanks.gui
{
   ...
   public class Renamed1823 extends DefaultButtonBase
   {
      private static var crystalIcon:Diamond = new Diamond();
      
      private var Renamed1904:int;
      
      private var _enable:Boolean = true;
      
      public function Renamed1823()
      {
         super();
      ...
      public function set Renamed1905(param1:int) : void
      {
         this.Renamed1904 = param1;
      }
      ...
      override public function set width(param1:Number) : void
      {
         ...
         _label.width = _width - 4 - crystalIcon.width;
      }
