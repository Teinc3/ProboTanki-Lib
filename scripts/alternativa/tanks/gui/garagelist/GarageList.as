package alternativa.tanks.gui.garagelist
{
   ...
   public class GarageList extends DiscreteSprite implements IResourceLoadingListener
   {
      ...
      {
         var _loc5_:GarageListRendererData;
         (_loc5_ = GarageListRendererData(this.dp.getItemAt(param1)))[param2] = param3;
         if(param4)
         {
      ...
      private function createIcon(param1:GarageListRendererData, param2:Boolean) : DisplayObject
      {
         ...
         {
            (_loc5_ = new Bitmap(param1.preview.data)).x = 200 - param1.preview.data.width >> 1;
            _loc5_.y = 18;
         ...
         if(param1.installed)
         {
            (_loc7_ = new Bitmap(mountedIcon)).x = 2;
            _loc7_.y = 2;
         ...
         if(param1.discount > 0 && (param1.rank <= 0 || param1.garageElement))
         {
            ...
            if(param1.timerDiscount != null)
            {
               ...
               {
                  (_loc9_ = new CountDownTimerLabel()).color = 15258050;
      ...
      {
         this.dp.sortOn(["appearanceTime","garageElement","rank","mod","showLockPremium","sort"],[Array.DESCENDING,Array.DESCENDING,Array.NUMERIC,Array.DESCENDING,Array.NUMERIC,Array.NUMERIC]);
      }
   }
}
