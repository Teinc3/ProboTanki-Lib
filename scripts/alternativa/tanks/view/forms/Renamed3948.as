package alternativa.tanks.view.forms
{
   ...
   public class Renamed558 extends Sprite
   {
      [Inject]
      ...
      private var Renamed3938:Bubble;
      
      private var Renamed3939:Alert;
      
      private var Renamed3940:Alert;
      
      private var Renamed3941:Boolean;
      
      public function Renamed558()
      {
      ...
      public function init() : void
      {
         ...
         this.Renamed3941 = true;
      }
      
      private function Renamed3942() : void
      {
         var _loc1_:int = 0;
      ...
      private function initEvents() : void
      {
         ...
         this.emailInput.addEventListener(LoginFormEvent.TEXT_CHANGED,this.Renamed3943);
      ...
      private function updatePasswordBlock(param1:Event) : void
      {
         ...
         if(_loc5_)
         {
            this.emailCheckIcon.addChild(this.Renamed3938);
         }
         else
         {
            this.Renamed3938.hide();
         }
      ...
      private function createBubbles() : void
      {
         ...
         this.Renamed3938 = EntranceBubbleFactory.emailInvalidBubble();
      }
      ...
      private function Renamed3944() : void
      {
      ...
      private function Renamed3943(param1:Event) : void
      {
         this.updatePasswordBlock(null);
      }
      
      public function Renamed3945() : void
      {
         if(this.Renamed3941)
         {
            this.removeEvents();
            this.Renamed3941 = false;
         }
      }
      ...
      public function Renamed3582(param1:Boolean, param2:String) : void
      {
         if(param1)
         {
            this.Renamed3939 = new Alert();
            this.Renamed3939.showAlert(param2,Vector.<String>([Renamed1616.OK]));
            if(parent)
            {
               parent.addChild(this.Renamed3939);
            }
            this.Renamed3939.addEventListener(AlertEvent.ALERT_BUTTON_PRESSED,this.Renamed3946);
         }
         else
         {
            this.Renamed3940 = new Alert();
            this.Renamed3940.showAlert(param2,Vector.<String>([Renamed1616.OK]));
            if(parent)
            {
               parent.addChild(this.Renamed3940);
            }
            this.Renamed3940.addEventListener(AlertEvent.ALERT_BUTTON_PRESSED,this.Renamed3947);
         }
      }
      
      private function Renamed3947(param1:AlertEvent) : void
      {
         this.Renamed3940.parent.removeChild(this.Renamed3940);
         this.Renamed3944();
      }
      
      private function Renamed3946(param1:AlertEvent) : void
      {
         this.Renamed3939.parent.removeChild(this.Renamed3939);
         this.Renamed3944();
      }
   }
}
