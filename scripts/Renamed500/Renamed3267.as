package Renamed500
{
   ...
   public class Renamed3267 extends Renamed1444 implements Renamed3268
   {
      private static const Renamed9859:Number = 48;
      ...
      private var Renamed4942:Renamed9861;
      
      private var container:Renamed908;
      
      public function Renamed3267(param1:Renamed1443)
      {
         this.position = new Vector3();
         this.direction = new Vector3();
         super(param1);
         this.Renamed4942 = new Renamed9861();
      }
      ...
      public function init(param1:Vector3, param2:Vector3, param3:Number, param4:Number, param5:Material, param6:int) : void
      {
         ...
         this.Renamed4942.init(Renamed9859,param3,param4,param5);
      }
