package Renamed17
{
   ...
   public class Renamed4556 implements Renamed1448, Renamed804, Renamed919
   {
      [Inject]
      ...
      private var Renamed5412:int = 1000;
      ...
      public function Renamed4556(param1:Renamed663, param2:Vector3, param3:int, param4:int, param5:Renamed843, param6:CollisionDetector, param7:Renamed4557)
      {
         this._state = Renamed5410.AT_BASE;
         super();
         this.teamType = param1;
         this.Renamed5411 = param2.clone();
         this._state = Renamed5410.AT_BASE;
         this.collisionDetector = param6;
         this.callback = param7;
         this.createSkin(param3,param4,param5);
         this.Renamed5415(param1);
         this.setPosition(param2);
         this.startTime = this.Renamed5412 * Math.random();
      }
      
      private function Renamed5415(param1:Renamed663) : void
      {
         var _loc2_:Renamed3820 = Renamed4730.Renamed3822(Renamed1587.CTF);
         var _loc3_:Renamed3823 = _loc2_.Renamed5102(param1);
      ...
      public function checkTrigger(param1:Body) : void
      {
         ...
         contacts.length = 0;
         this.callback.Renamed5395(this);
      }
      
      public function render(param1:int, param2:int) : void
      {
         this.skin.Renamed1653(int((param1 - this.startTime) / this.Renamed5412));
