package assets.cellrenderer.battlelist
{
   ...
   public class CellOffUp extends ButtonState
   {
      public function CellOffUp()
      {
         super();
         bmpLeft = new cell_off_UP_LEFT(1,1);
         bmpCenter = new cell_off_UP_CENTER(1,1);
         bmpRight = new cell_off_UP_RIGHT(1,1);
      }
